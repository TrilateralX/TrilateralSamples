...
HX_DECLARE_STACK_FRAME(_hx_pos_ecc600380690180e_13_new)
			...
			*(void **)__this = Vertex_obj::_hx_vtable;
{
            	...
            	HX_STACKFRAME(&_hx_pos_ecc600380690180e_13_new)
HXLINE(  17)		( ( ::trilateral3::matrix::Vertex)(__this) )->w = ((Float)1.);
HXLINE(  16)		( ( ::trilateral3::matrix::Vertex)(__this) )->z = ((Float)0.);
HXLINE(  15)		( ( ::trilateral3::matrix::Vertex)(__this) )->y = ((Float)0.);
HXLINE(  14)		( ( ::trilateral3::matrix::Vertex)(__this) )->x = ((Float)0.);
HXLINE(  19)		( ( ::trilateral3::matrix::Vertex)(__this) )->x = x;
HXLINE(  20)		( ( ::trilateral3::matrix::Vertex)(__this) )->y = y;
HXLINE(  21)		( ( ::trilateral3::matrix::Vertex)(__this) )->z = z;
HXLINE(  22)		( ( ::trilateral3::matrix::Vertex)(__this) )->w = w;
            	}
