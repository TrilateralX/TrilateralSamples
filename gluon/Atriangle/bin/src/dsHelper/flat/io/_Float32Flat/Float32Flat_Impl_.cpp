...
HX_LOCAL_STACK_FRAME(_hx_pos_bbba311f8878eef7_46_get_size,"dsHelper.flat.io._Float32Flat.Float32Flat_Impl_","get_size",0x4b0e4d39,"dsHelper.flat.io._Float32Flat.Float32Flat_Impl_.get_size","dsHelper/flat/io/Float32Flat.hx",46,0x3517e5af)
HX_LOCAL_STACK_FRAME(_hx_pos_bbba311f8878eef7_50_set_size,"dsHelper.flat.io._Float32Flat.Float32Flat_Impl_","set_size",0xf96ba6ad,"dsHelper.flat.io._Float32Flat.Float32Flat_Impl_.set_size","dsHelper/flat/io/Float32Flat.hx",50,0x3517e5af)
namespace dsHelper{
namespace flat{
namespace io{
...
int Float32Flat_Impl__obj::get_size( ::typedarray::Float32ArrayImpl this1){
            	HX_STACKFRAME(&_hx_pos_bbba311f8878eef7_46_get_size)
HXDLIN(  46)		if ((1 >= this1->length)) {
HXDLIN(  46)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::haxe::io::Error_obj::OutsideBounds_dyn()));
            		}
HXDLIN(  46)		int p = (4 + this1->byteOffset);
HXDLIN(  46)		return ::Std_obj::_hx_int(( (Float)( ::__hxcpp_memory_get_float(this1->buffer->b,p)) ));
            	}
...
int Float32Flat_Impl__obj::set_size( ::typedarray::Float32ArrayImpl this1,int id){
            	HX_STACKFRAME(&_hx_pos_bbba311f8878eef7_50_set_size)
HXLINE(  51)		{
HXLINE(  51)			Float pos_ = ( (Float)(id) );
HXDLIN(  51)			{
HXLINE(  51)				if ((0 >= this1->length)) {
HXLINE(  51)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::haxe::io::Error_obj::OutsideBounds_dyn()));
            				}
HXDLIN(  51)				int p = this1->byteOffset;
HXDLIN(  51)				 ::__hxcpp_memory_set_float(this1->buffer->b,p,pos_);
            			}
HXDLIN(  51)			if ((0 >= this1->length)) {
HXLINE(  51)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::haxe::io::Error_obj::OutsideBounds_dyn()));
            			}
HXDLIN(  51)			int p1 = this1->byteOffset;
HXDLIN(  51)			float _hx_tmp =  ::__hxcpp_memory_get_float(this1->buffer->b,p1);
HXDLIN(  51)			if ((1 >= this1->length)) {
HXLINE(  51)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::haxe::io::Error_obj::OutsideBounds_dyn()));
            			}
HXDLIN(  51)			int p2 = (4 + this1->byteOffset);
HXDLIN(  51)			if ((_hx_tmp > ( ::__hxcpp_memory_get_float(this1->buffer->b,p2) - ( (float)(1) )))) {
HXLINE(  51)				if ((0 >= this1->length)) {
HXLINE(  51)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::haxe::io::Error_obj::OutsideBounds_dyn()));
            				}
HXDLIN(  51)				int p = this1->byteOffset;
HXDLIN(  51)				float v =  ::__hxcpp_memory_get_float(this1->buffer->b,p);
HXDLIN(  51)				{
HXLINE(  51)					if ((1 >= this1->length)) {
HXLINE(  51)						HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::haxe::io::Error_obj::OutsideBounds_dyn()));
            					}
HXDLIN(  51)					int p1 = (4 + this1->byteOffset);
HXDLIN(  51)					 ::__hxcpp_memory_set_float(this1->buffer->b,p1,v);
            				}
            			}
            		}
HXLINE(  52)		return id;
