...
HX_DEFINE_STACK_FRAME(_hx_pos_ad01946bc6c4afa6_12_new,"gluon.webgl.native.GLObject","new",0x55bafa59,"gluon.webgl.native.GLObject.new","gluon/webgl/native/GLObject.hx",12,0x02261018)
HX_LOCAL_STACK_FRAME(_hx_pos_ad01946bc6c4afa6_21_finalize,"gluon.webgl.native.GLObject","finalize",0xdb1b5505,"gluon.webgl.native.GLObject.finalize","gluon/webgl/native/GLObject.hx",21,0x02261018)
namespace gluon{
namespace webgl{
namespace native{

void GLObject_obj::__construct( ::gluon::webgl::native::GLContext context,unsigned int handle){
            	HX_STACKFRAME(&_hx_pos_ad01946bc6c4afa6_12_new)
HXLINE(  13)		this->context = context;
HXLINE(  14)		this->handle = handle;
HXLINE(  15)		_hx_add_finalizable(::hx::ObjectPtr<OBJ_>(this),false);
            	}
...
void GLObject_obj::finalize(){
            	HX_STACKFRAME(&_hx_pos_ad01946bc6c4afa6_21_finalize)
HXDLIN(  21)		this->handle = ( (unsigned int)(0) );
            	}
