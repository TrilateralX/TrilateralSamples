...
HXLINE(1798)		 ::hxGeomAlgo::_Tess2::TessHalfEdge eDst2 = eDst->Sym;
HXDLIN(1798)		eDst2->winding = (eDst2->winding + eSrc->Sym->winding);
            	}
...
HXLINE(2107)		::Array< Float > isect1 = isect->coords;
HXDLIN(2107)		int _hx_tmp = 0;
HXDLIN(2107)		isect1[_hx_tmp] = (isect1->__get(_hx_tmp) + ((w0 * org->coords->__get(0)) + (w1 * dst->coords->__get(0))));
HXLINE(2108)		::Array< Float > isect2 = isect->coords;
HXDLIN(2108)		int _hx_tmp1 = 1;
HXDLIN(2108)		isect2[_hx_tmp1] = (isect2->__get(_hx_tmp1) + ((w0 * org->coords->__get(1)) + (w1 * dst->coords->__get(1))));
HXLINE(2109)		::Array< Float > isect3 = isect->coords;
HXDLIN(2109)		int _hx_tmp2 = 2;
HXDLIN(2109)		isect3[_hx_tmp2] = (isect3->__get(_hx_tmp2) + ((w0 * org->coords->__get(2)) + (w1 * dst->coords->__get(2))));
            	}
