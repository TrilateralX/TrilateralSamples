...
HX_LOCAL_STACK_FRAME(_hx_pos_03b80f763c8d9d0d_62_initEventLoop,"sys.thread._Thread.Thread_Impl_","initEventLoop",0xf8094852,"sys.thread._Thread.Thread_Impl_.initEventLoop","/usr/local/lib/haxe/std/cpp/_std/sys/thread/Thread.hx",62,0x29fdb453)
HX_LOCAL_STACK_FRAME(_hx_pos_03b80f763c8d9d0d_67_processEvents,"sys.thread._Thread.Thread_Impl_","processEvents",0xf30238cc,"sys.thread._Thread.Thread_Impl_.processEvents","/usr/local/lib/haxe/std/cpp/_std/sys/thread/Thread.hx",67,0x29fdb453)
namespace sys{
namespace thread{
namespace _Thread{
...
void Thread_Impl__obj::initEventLoop(){
            	HX_GC_STACKFRAME(&_hx_pos_03b80f763c8d9d0d_62_initEventLoop)
HXDLIN(  62)		::sys::thread::_Thread::HaxeThread_obj::current()->events =  ::sys::thread::EventLoop_obj::__alloc( HX_CTX );
            	}
...
void Thread_Impl__obj::processEvents(){
            	HX_STACKFRAME(&_hx_pos_03b80f763c8d9d0d_67_processEvents)
HXDLIN(  67)		::sys::thread::_Thread::HaxeThread_obj::current()->events->loop();
            	}
