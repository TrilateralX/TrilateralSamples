...
HX_LOCAL_STACK_FRAME(_hx_pos_c1355cde420a5cd1_6_boot,"trilateral3.Trilateral","boot",0xf4d7b2ad,"trilateral3.Trilateral.boot","trilateral3/Trilateral.hx",6,0xc487b82a)
...
{
{
            	HX_STACKFRAME(&_hx_pos_c1355cde420a5cd1_6_boot)
HXDLIN(   6)		transformMatrix = null();
            	}
}
