...
HX_DEFINE_STACK_FRAME(_hx_pos_bf2a6fc66f3165af_20_new,"trilateral3.drawing.Pen","new",0x0b5158b4,"trilateral3.drawing.Pen.new","trilateral3/drawing/Pen.hx",20,0xcfd64fbe)
namespace trilateral3{
namespace drawing{

void Pen_obj::__construct( ::Dynamic paintType_){
            	HX_STACKFRAME(&_hx_pos_bf2a6fc66f3165af_20_new)
HXLINE(  28)		this->currentColor = 16435934;
HXLINE(  23)		this->useTexture = false;
HXLINE(  22)		this->z2D = ((Float)0.);
HXLINE(  39)		this->paintType = paintType_;
            	}
...
::hx::Val Pen_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 3:
		if (HX_FIELD_EQ(inName,"z2D") ) { return ::hx::Val( z2D ); }
		break;
	case 9:
...
::hx::Val Pen_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"z2D") ) { z2D=inValue.Cast< Float >(); return inValue; }
		break;
	case 9:
...
{
	outFields->push(HX_("z2D",cc,be,5c,00));
...
static ::hx::StorageInfo Pen_obj_sMemberStorageInfo[] = {
	{::hx::fsFloat,(int)offsetof(Pen_obj,z2D),HX_("z2D",cc,be,5c,00)},
