...
HX_DEFINE_STACK_FRAME(_hx_pos_ecc600380690180e_13_new,"trilateral3.matrix.Vertex","new",0xdc408f5c,"trilateral3.matrix.Vertex.new","trilateral3/matrix/Vertex.hx",13,0x645fd974)
...
HXLINE(  17)		this->w = ((Float)1.);
HXLINE(  16)		this->z = ((Float)0.);
