...
HX_DEFINE_STACK_FRAME(_hx_pos_feb72ef12aa12933_45_new,"typedarray.Float32ArrayImpl","new",0x1ffbda4f,"typedarray.Float32ArrayImpl.new","typedarray/Float32Array.hx",45,0xf78cfaa0)
HX_LOCAL_STACK_FRAME(_hx_pos_feb72ef12aa12933_55__get,"typedarray.Float32ArrayImpl","_get",0xd27a6cc8,"typedarray.Float32ArrayImpl._get","typedarray/Float32Array.hx",55,0xf78cfaa0)
HX_LOCAL_STACK_FRAME(_hx_pos_feb72ef12aa12933_72__set,"typedarray.Float32ArrayImpl","_set",0xd28387d4,"typedarray.Float32ArrayImpl._set","typedarray/Float32Array.hx",72,0xf78cfaa0)
HX_LOCAL_STACK_FRAME(_hx_pos_feb72ef12aa12933_90_iterator,"typedarray.Float32ArrayImpl","iterator",0x787cdd9f,"typedarray.Float32ArrayImpl.iterator","typedarray/Float32Array.hx",90,0xf78cfaa0)
namespace typedarray{

void Float32ArrayImpl_obj::__construct( ::Dynamic length, ::haxe::io::Bytes buffer, ::Dynamic byteOffset, ::Dynamic byteLength){
            	HX_STACKFRAME(&_hx_pos_feb72ef12aa12933_45_new)
HXDLIN(  45)		super::__construct(4,length,buffer,byteOffset,byteLength);
            	}
...
float Float32ArrayImpl_obj::_get(int i){
            	HX_STACKFRAME(&_hx_pos_feb72ef12aa12933_55__get)
HXLINE(  57)		bool _hx_tmp;
HXDLIN(  57)		if ((i >= 0)) {
HXLINE(  57)			_hx_tmp = (i >= this->length);
            		}
            		else {
HXLINE(  57)			_hx_tmp = true;
            		}
HXDLIN(  57)		if (_hx_tmp) {
HXLINE(  58)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::haxe::io::Error_obj::OutsideBounds_dyn()));
            		}
HXLINE(  62)		int p = ((i * 4) + this->byteOffset);
HXLINE(  65)		return  ::__hxcpp_memory_get_float(this->buffer->b,p);
            	}
...
float Float32ArrayImpl_obj::_set(int i,float v){
            	HX_STACKFRAME(&_hx_pos_feb72ef12aa12933_72__set)
HXLINE(  74)		bool _hx_tmp;
HXDLIN(  74)		if ((i >= 0)) {
HXLINE(  74)			_hx_tmp = (i >= this->length);
            		}
            		else {
...
HXLINE(  79)		int p = ((i * 4) + this->byteOffset);
HXLINE(  82)		 ::__hxcpp_memory_set_float(this->buffer->b,p,v);
HXLINE(  86)		return v;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(Float32ArrayImpl_obj,_set,return )
 ...
 ::typedarray::ArrayBufferViewImplIterator_typedarray__Float32Array_ArrayType Float32ArrayImpl_obj::iterator(){
            	HX_GC_STACKFRAME(&_hx_pos_feb72ef12aa12933_90_iterator)
HXDLIN(  90)		return  ::typedarray::ArrayBufferViewImplIterator_typedarray__Float32Array_ArrayType_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this));
            	}
