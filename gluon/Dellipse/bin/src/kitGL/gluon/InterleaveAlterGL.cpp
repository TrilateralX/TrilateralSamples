...
HX_DEFINE_STACK_FRAME(_hx_pos_90e2645f1ab115eb_23_new,"kitGL.gluon.InterleaveAlterGL","new",0x07f6c120,"kitGL.gluon.InterleaveAlterGL.new","kitGL/gluon/InterleaveAlterGL.hx",23,0x2c0fe612)
HX_LOCAL_STACK_FRAME(_hx_pos_90e2645f1ab115eb_43_render,"kitGL.gluon.InterleaveAlterGL","render",0x10e57296,"kitGL.gluon.InterleaveAlterGL.render","kitGL/gluon/InterleaveAlterGL.hx",43,0x2c0fe612)
HX_LOCAL_STACK_FRAME(_hx_pos_90e2645f1ab115eb_58_renderDraw,"kitGL.gluon.InterleaveAlterGL","renderDraw",0x20eacdba,"kitGL.gluon.InterleaveAlterGL.renderDraw","kitGL/gluon/InterleaveAlterGL.hx",58,0x2c0fe612)
namespace kitGL{
namespace gluon{

void InterleaveAlterGL_obj::__construct( ::gluon::webgl::native::GLContext gl){
            	HX_STACKFRAME(&_hx_pos_90e2645f1ab115eb_23_new)
...
void InterleaveAlterGL_obj::render(int width,int height){
            	HX_STACKFRAME(&_hx_pos_90e2645f1ab115eb_43_render)
HXLINE(  45)		int dim;
...
HXDLIN(  52)			 ::typedarray::_BufferSource::BufferSourceType data = ::typedarray::_BufferSource::BufferSourceType_obj::BufferView(this->interleaveDataGL->__Field(HX_("get_data",b3,11,1e,c2),::hx::paccDynamic)());
...
HXDLIN(  54)			glDrawArrays(( (unsigned int)(4) ),0,( (int)(this->interleaveDataGL->__Field(HX_("get_size",4a,5c,0e,cc),::hx::paccDynamic)()) ));
HXDLIN(  54)			::gluon::webgl::_GLContext::GLContext_Impl__obj::reportErrors(this4,HX_("drawArrays",de,f3,b3,f9));
            		}
            	}


HX_DEFINE_DYNAMIC_FUNC2(InterleaveAlterGL_obj,render,(void))

void InterleaveAlterGL_obj::renderDraw(){
            	HX_STACKFRAME(&_hx_pos_90e2645f1ab115eb_58_renderDraw)
            	}
...
::hx::ObjectPtr< InterleaveAlterGL_obj > InterleaveAlterGL_obj::__new( ::gluon::webgl::native::GLContext gl) {
	::hx::ObjectPtr< InterleaveAlterGL_obj > __this = new InterleaveAlterGL_obj();
	__this->__construct(gl);
	return __this;
}

::hx::ObjectPtr< InterleaveAlterGL_obj > InterleaveAlterGL_obj::__alloc(::hx::Ctx *_hx_ctx, ::gluon::webgl::native::GLContext gl) {
	InterleaveAlterGL_obj *__this = (InterleaveAlterGL_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(InterleaveAlterGL_obj), true, "kitGL.gluon.InterleaveAlterGL"));
...
static ::hx::StorageInfo InterleaveAlterGL_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsInt,(int)offsetof(InterleaveAlterGL_obj,posLoc),HX_("posLoc",4c,63,b0,fd)},
	{::hx::fsInt,(int)offsetof(InterleaveAlterGL_obj,colorLoc),HX_("colorLoc",dd,5a,ea,89)},
	{::hx::fsObject /*  ::gluon::webgl::native::GLContext */ ,(int)offsetof(InterleaveAlterGL_obj,gl),HX_("gl",25,5a,00,00)},
	{::hx::fsObject /*  ::gluon::webgl::native::GLProgram */ ,(int)offsetof(InterleaveAlterGL_obj,program),HX_("program",84,4a,f9,f3)},
	{::hx::fsObject /*  ::gluon::webgl::native::GLBuffer */ ,(int)offsetof(InterleaveAlterGL_obj,buf),HX_("buf",33,c3,4a,00)},
	{ ::hx::fsUnknown, 0, null()}
};
...
void InterleaveAlterGL_obj::__register()
{
	...
	__mClass->mName = HX_("kitGL.gluon.InterleaveAlterGL",2e,f1,7f,af);
