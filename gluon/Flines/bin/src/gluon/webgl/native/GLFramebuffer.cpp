...
HX_DEFINE_STACK_FRAME(_hx_pos_cd605dff5baf0e4e_4_new,"gluon.webgl.native.GLFramebuffer","new",0xeba53037,"gluon.webgl.native.GLFramebuffer.new","gluon/webgl/native/GLFramebuffer.hx",4,0x7390f698)
HX_LOCAL_STACK_FRAME(_hx_pos_cd605dff5baf0e4e_7_finalize,"gluon.webgl.native.GLFramebuffer","finalize",0x424b1a67,"gluon.webgl.native.GLFramebuffer.finalize","gluon/webgl/native/GLFramebuffer.hx",7,0x7390f698)
namespace gluon{
namespace webgl{
namespace native{

void GLFramebuffer_obj::__construct( ::gluon::webgl::native::GLContext context,unsigned int handle){
            	HX_STACKFRAME(&_hx_pos_cd605dff5baf0e4e_4_new)
...
void GLFramebuffer_obj::finalize(){
            	HX_STACKFRAME(&_hx_pos_cd605dff5baf0e4e_7_finalize)
HXLINE(   8)		{
HXLINE(   8)			 ::gluon::webgl::native::GLContext _this = this->context;
HXDLIN(   8)			{
HXLINE(   8)				if ((this->handle != 0)) {
HXLINE(   8)					glDeleteFramebuffers(1,&(this->handle));
            				}
