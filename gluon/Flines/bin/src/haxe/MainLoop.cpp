...
HX_LOCAL_STACK_FRAME(_hx_pos_c09dd4c76a148f98_66_hasEvents,"haxe.MainLoop","hasEvents",0xbbf2790a,"haxe.MainLoop.hasEvents","/usr/local/lib/haxe/std/haxe/MainLoop.hx",66,0x4a7d9295)
HX_LOCAL_STACK_FRAME(_hx_pos_c09dd4c76a148f98_87_add,"haxe.MainLoop","add",0xf65145d8,"haxe.MainLoop.add","/usr/local/lib/haxe/std/haxe/MainLoop.hx",87,0x4a7d9295)
HX_LOCAL_STACK_FRAME(_hx_pos_c09dd4c76a148f98_99_sortEvents,"haxe.MainLoop","sortEvents",0x1a386640,"haxe.MainLoop.sortEvents","/usr/local/lib/haxe/std/haxe/MainLoop.hx",99,0x4a7d9295)
HX_LOCAL_STACK_FRAME(_hx_pos_c09dd4c76a148f98_164_tick,"haxe.MainLoop","tick",0x9d5eafc6,"haxe.MainLoop.tick","/usr/local/lib/haxe/std/haxe/MainLoop.hx",164,0x4a7d9295)
namespace haxe{
...
bool MainLoop_obj::hasEvents(){
            	HX_STACKFRAME(&_hx_pos_c09dd4c76a148f98_66_hasEvents)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(MainLoop_obj,hasEvents,return )
 ...
 ::haxe::MainEvent MainLoop_obj::add( ::Dynamic f,::hx::Null< int >  __o_priority){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_c09dd4c76a148f98_87_add)
HXLINE(  88)		if (::hx::IsNull( f )) {
HXLINE(  89)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Event function is null",5b,98,d0,36)));
            		}
...
void MainLoop_obj::sortEvents(){
            	HX_STACKFRAME(&_hx_pos_c09dd4c76a148f98_99_sortEvents)
...
Float MainLoop_obj::tick(){
            	HX_STACKFRAME(&_hx_pos_c09dd4c76a148f98_164_tick)
