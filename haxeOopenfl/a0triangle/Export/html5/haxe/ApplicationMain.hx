...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TrilateralOpenFLTriangle", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TrilateralOpenFLTriangle", null, 1000, 1000);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "TrilateralOpenFLTriangle";
		app.meta["name"] = "TrilateralOpenFLTriangle";
		app.meta["packageName"] = "net.nanjizal.trilateralOpenFLTriangle";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "TrilateralOpenFLTriangle",
			width: 1000,
			x: null,
			y: null,
		};
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("TrilateralOpenFLTriangle")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess TrilateralOpenFLTriangle.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"TrilateralOpenFLTriangle\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"TrilateralOpenFLTriangle\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends TrilateralOpenFLTriangle {}
#else
class DocumentClass
{
