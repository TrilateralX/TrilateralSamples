...
class TrilateralLimeFill extends InterleaveAlterGL {
    ...
    poly2tri;
        */
        var start = pen.pos;
        triangulate( pen, sketch, tess2 );  // seems broken..
        // should not be needed
        var end = pen.pos;
        pen.pos = start;
        var numberTriangles = Std.int( end-start );
        trace( numberTriangles );
        pen.colorTriangles( periniNavi, numberTriangles );
    }
    override
