...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TrilateralOpenFLSVG", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TrilateralOpenFLSVG", null, 1000, 1000);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "TrilateralOpenFLSVG";
		app.meta["name"] = "TrilateralOpenFLSVG";
		app.meta["packageName"] = "net.nanjizal.trilateralOpenFLSVG";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("TrilateralOpenFLSVG")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess TrilateralOpenFLSVG.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"TrilateralOpenFLSVG\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"TrilateralOpenFLSVG\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends TrilateralOpenFLSVG {}
#else
class DocumentClass
{
