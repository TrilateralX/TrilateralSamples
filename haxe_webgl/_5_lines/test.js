...
TrilateralLines.__super__ = kitGL_glWeb_InterleaveAlterGL;
TrilateralLines.prototype = $extend(kitGL_glWeb_InterleaveAlterGL.prototype,{
	draw: function() {
...
function TrilateralLines_main() {
	...
	haxe_Log.trace("TrilateralLines example",{ fileName : "TrilateralLines.hx", lineNumber : 28, className : "_TrilateralLines.TrilateralLines_Fields_", methodName : "main"});
}
