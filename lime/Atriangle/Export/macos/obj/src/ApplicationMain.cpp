...
HXLINE(  12)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("TrilateralLimeTriangle",e9,29,91,f6),::ApplicationMain_obj::create_dyn());
...
HXLINE(  27)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("TrilateralLimeTriangle",e9,29,91,f6));
