...
HX_LOCAL_STACK_FRAME(_hx_pos_ecc600380690180e_24_values,"trilateral3.matrix.Vertex","values",0xec66ca66,"trilateral3.matrix.Vertex.values","trilateral3/matrix/Vertex.hx",24,0x645fd974)
...
::String Vertex_obj::values(){
            	HX_STACKFRAME(&_hx_pos_ecc600380690180e_24_values)
HXDLIN(  24)		return ((((((this->x + HX_(" ",20,00,00,00)) + this->y) + HX_(" ",20,00,00,00)) + this->z) + HX_(" ",20,00,00,00)) + this->w);
            	}


HX_DEFINE_DYNAMIC_FUNC0(Vertex_obj,values,return )
