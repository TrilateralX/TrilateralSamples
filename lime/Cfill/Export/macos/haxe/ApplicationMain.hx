...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TrilateralLimeFill", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		app.meta.set("file", "TrilateralLimeFill");
		app.meta.set("name", "TrilateralLimeFill");
		app.meta.set("packageName", "net.nanjizal.trilateralLimeFill");
