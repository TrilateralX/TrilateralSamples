...
class HXCPP_CLASS_ATTRIBUTES Sketch_obj : public ::hx::Object
{
	...
	public:
		...
		int aiColorSet(::String colorType,::Array< ::String > arr);
		::Dynamic aiColorSet_dyn();

		::String getColorType(::Array< ::String > arr);
		::Dynamic getColorType_dyn();

		void aiStringPart(::String str,Float x,Float y,::hx::Null< Float >  flipY);
		::Dynamic aiStringPart_dyn();
