...
HX_LOCAL_STACK_FRAME(_hx_pos_e52bee1e8b043d6c_21_values,"trilateral3.matrix.MatrixDozen","values",0xf728abbf,"trilateral3.matrix.MatrixDozen.values","trilateral3/matrix/MatrixDozen.hx",21,0x14397a8d)
...
::String MatrixDozen_obj::values(){
            	HX_STACKFRAME(&_hx_pos_e52bee1e8b043d6c_21_values)
HXDLIN(  21)		return (((((((((((((((((((((((this->a + HX_(" ",20,00,00,00)) + this->b) + HX_(" ",20,00,00,00)) + this->c) + HX_(" ",20,00,00,00)) + this->d) + HX_("\n ",d6,08,00,00)) + this->e) + HX_(" ",20,00,00,00)) + this->f) + HX_(" ",20,00,00,00)) + this->g) + HX_(" ",20,00,00,00)) + this->h) + HX_("\n ",d6,08,00,00)) + this->i) + HX_(" ",20,00,00,00)) + this->j) + HX_(" ",20,00,00,00)) + this->k) + HX_(" ",20,00,00,00)) + this->l) + HX_("\n ",d6,08,00,00));
            	}


HX_DEFINE_DYNAMIC_FUNC0(MatrixDozen_obj,values,return )
...
::hx::Val MatrixDozen_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 1:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"values") ) { return ::hx::Val( values_dyn() ); }
	}
