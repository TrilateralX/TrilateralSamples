...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TrilateralLimeEllipse", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		app.meta.set("file", "TrilateralLimeEllipse");
		app.meta.set("name", "TrilateralLimeEllipse");
		app.meta.set("packageName", "net.nanjizal.trilateralLimeEllipse");
