...
HX_LOCAL_STACK_FRAME(_hx_pos_0b1b2dc758b14196_20_quickTriangle,"justPath.SvgPath","quickTriangle",0x77f4b173,"justPath.SvgPath.quickTriangle","justPath/SvgPath.hx",20,0x4df92af3)
...
HX_LOCAL_STACK_FRAME(_hx_pos_0b1b2dc758b14196_391_extractArgs,"justPath.SvgPath","extractArgs",0xdadb9a5c,"justPath.SvgPath.extractArgs","justPath/SvgPath.hx",391,0x4df92af3)
HX_LOCAL_STACK_FRAME(_hx_pos_0b1b2dc758b14196_474_nextChar,"justPath.SvgPath","nextChar",0x3d1e8f8b,"justPath.SvgPath.nextChar","justPath/SvgPath.hx",474,0x4df92af3)
namespace justPath{
...
void SvgPath_obj::quickTriangle(Float x0,Float y0,Float off){
            	HX_STACKFRAME(&_hx_pos_0b1b2dc758b14196_20_quickTriangle)
HXLINE(  21)		::justPath::IPathContext_obj::moveTo(this->pathContext,x0,(y0 - off));
HXLINE(  22)		::justPath::IPathContext_obj::lineTo(this->pathContext,(x0 + off),(y0 + off));
HXLINE(  23)		::justPath::IPathContext_obj::lineTo(this->pathContext,(x0 - off),(y0 + off));
HXLINE(  24)		::justPath::IPathContext_obj::lineTo(this->pathContext,x0,(y0 - off));
            	}


HX_DEFINE_DYNAMIC_FUNC3(SvgPath_obj,quickTriangle,(void))
...
void SvgPath_obj::extractArgs( ::Dynamic __o_process){
            		 ::Dynamic process = __o_process;
            		if (::hx::IsNull(__o_process)) process = true;
            	HX_GC_STACKFRAME(&_hx_pos_0b1b2dc758b14196_391_extractArgs)
HXLINE( 392)		{
HXLINE( 392)			 ::justPath::StoreF6 _this = this->store;
HXDLIN( 392)			_this->l = 0;
HXDLIN( 392)			_this->s0 = null();
HXDLIN( 392)			_this->s1 = null();
HXDLIN( 392)			_this->s2 = null();
HXDLIN( 392)			_this->s3 = null();
HXDLIN( 392)			_this->s4 = null();
HXDLIN( 392)			_this->s5 = null();
HXDLIN( 392)			_this->s6 = null();
            		}
HXLINE( 394)		this->c = this->str.cca(this->pos++);
HXLINE( 395)		int count = 0;
HXLINE( 396)		::String temp = HX_("",00,00,00,00);
HXLINE( 397)		bool exit = false;
HXLINE( 398)		while(true){
HXLINE( 399)			switch((int)(this->c)){
            				case (int)32: case (int)44: {
HXLINE( 437)					if ((temp != HX_("",00,00,00,00))) {
HXLINE( 439)						if (( (bool)(process) )) {
HXLINE( 440)							if (((this->store->l & 1) == 0)) {
HXLINE( 441)								 ::justPath::StoreF6 _this = this->store;
HXDLIN( 441)								 ::Dynamic v = ::Std_obj::parseFloat(temp);
HXDLIN( 441)								switch((int)(_this->l)){
            									case (int)0: {
HXLINE( 441)										_this->s0 = v;
            									}
            									break;
            									case (int)1: {
HXLINE( 441)										_this->s1 = v;
            									}
            									break;
            									case (int)2: {
HXLINE( 441)										_this->s2 = v;
            									}
            									break;
            									case (int)3: {
HXLINE( 441)										_this->s3 = v;
            									}
            									break;
            									case (int)4: {
HXLINE( 441)										_this->s4 = v;
            									}
            									break;
            									case (int)5: {
HXLINE( 441)										_this->s5 = v;
            									}
            									break;
            									default:{
HXLINE( 441)										if (::hx::IsNull( _this->s6 )) {
HXLINE( 441)											_this->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            										}
HXDLIN( 441)										{
HXLINE( 441)											 ::justPath::StoreF6 _this1 = _this->s6;
HXDLIN( 441)											switch((int)(_this1->l)){
            												case (int)0: {
HXLINE( 441)													_this1->s0 = v;
            												}
            												break;
            												case (int)1: {
HXLINE( 441)													_this1->s1 = v;
            												}
            												break;
            												case (int)2: {
HXLINE( 441)													_this1->s2 = v;
            												}
            												break;
            												case (int)3: {
HXLINE( 441)													_this1->s3 = v;
            												}
            												break;
            												case (int)4: {
HXLINE( 441)													_this1->s4 = v;
            												}
            												break;
            												case (int)5: {
HXLINE( 441)													_this1->s5 = v;
            												}
            												break;
            												default:{
HXLINE( 441)													if (::hx::IsNull( _this1->s6 )) {
HXLINE( 441)														_this1->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            													}
HXDLIN( 441)													_this1->s6->push(v);
            												}
            											}
HXDLIN( 441)											_this1->l++;
            										}
...
HXLINE( 443)								 ::justPath::StoreF6 _this = this->store;
HXDLIN( 443)								 ::Dynamic v = ::Std_obj::parseFloat(temp);
HXDLIN( 443)								switch((int)(_this->l)){
            									case (int)0: {
HXLINE( 443)										_this->s0 = v;
            									}
            									break;
            									case (int)1: {
HXLINE( 443)										_this->s1 = v;
            									}
            									break;
            									case (int)2: {
HXLINE( 443)										_this->s2 = v;
            									}
            									break;
            									case (int)3: {
HXLINE( 443)										_this->s3 = v;
            									}
            									break;
            									case (int)4: {
HXLINE( 443)										_this->s4 = v;
            									}
            									break;
            									case (int)5: {
HXLINE( 443)										_this->s5 = v;
            									}
            									break;
            									default:{
HXLINE( 443)										if (::hx::IsNull( _this->s6 )) {
HXLINE( 443)											_this->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            										}
HXDLIN( 443)										{
HXLINE( 443)											 ::justPath::StoreF6 _this1 = _this->s6;
HXDLIN( 443)											switch((int)(_this1->l)){
            												case (int)0: {
HXLINE( 443)													_this1->s0 = v;
            												}
            												break;
            												case (int)1: {
HXLINE( 443)													_this1->s1 = v;
            												}
            												break;
            												case (int)2: {
HXLINE( 443)													_this1->s2 = v;
            												}
            												break;
            												case (int)3: {
HXLINE( 443)													_this1->s3 = v;
            												}
            												break;
            												case (int)4: {
HXLINE( 443)													_this1->s4 = v;
            												}
            												break;
            												case (int)5: {
HXLINE( 443)													_this1->s5 = v;
            												}
            												break;
            												default:{
HXLINE( 443)													if (::hx::IsNull( _this1->s6 )) {
HXLINE( 443)														_this1->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            													}
HXDLIN( 443)													_this1->s6->push(v);
            												}
            											}
HXDLIN( 443)											_this1->l++;
            										}
...
HXLINE( 446)							 ::justPath::StoreF6 _this = this->store;
HXDLIN( 446)							 ::Dynamic v = ::Std_obj::parseFloat(temp);
HXDLIN( 446)							switch((int)(_this->l)){
            								case (int)0: {
HXLINE( 446)									_this->s0 = v;
            								}
            								break;
            								case (int)1: {
HXLINE( 446)									_this->s1 = v;
            								}
            								break;
            								case (int)2: {
HXLINE( 446)									_this->s2 = v;
            								}
            								break;
            								case (int)3: {
HXLINE( 446)									_this->s3 = v;
            								}
            								break;
            								case (int)4: {
HXLINE( 446)									_this->s4 = v;
            								}
            								break;
            								case (int)5: {
HXLINE( 446)									_this->s5 = v;
            								}
            								break;
            								default:{
HXLINE( 446)									if (::hx::IsNull( _this->s6 )) {
HXLINE( 446)										_this->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            									}
HXDLIN( 446)									{
HXLINE( 446)										 ::justPath::StoreF6 _this1 = _this->s6;
HXDLIN( 446)										switch((int)(_this1->l)){
            											case (int)0: {
HXLINE( 446)												_this1->s0 = v;
            											}
            											break;
            											case (int)1: {
HXLINE( 446)												_this1->s1 = v;
            											}
            											break;
            											case (int)2: {
HXLINE( 446)												_this1->s2 = v;
            											}
            											break;
            											case (int)3: {
HXLINE( 446)												_this1->s3 = v;
            											}
            											break;
            											case (int)4: {
HXLINE( 446)												_this1->s4 = v;
            											}
            											break;
            											case (int)5: {
HXLINE( 446)												_this1->s5 = v;
            											}
            											break;
            											default:{
HXLINE( 446)												if (::hx::IsNull( _this1->s6 )) {
HXLINE( 446)													_this1->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            												}
HXDLIN( 446)												_this1->s6->push(v);
            											}
            										}
HXDLIN( 446)										_this1->l++;
            									}
...
HXLINE( 448)						temp = HX_("",00,00,00,00);
            					}
            				}
            				break;
            				case (int)45: {
HXLINE( 401)					if ((temp != HX_("",00,00,00,00))) {
HXLINE( 403)						if (( (bool)(process) )) {
HXLINE( 404)							if (((this->store->l & 1) == 0)) {
HXLINE( 405)								 ::justPath::StoreF6 _this = this->store;
HXDLIN( 405)								 ::Dynamic v = ::Std_obj::parseFloat(temp);
HXDLIN( 405)								switch((int)(_this->l)){
            									case (int)0: {
HXLINE( 405)										_this->s0 = v;
            									}
            									break;
            									case (int)1: {
HXLINE( 405)										_this->s1 = v;
            									}
            									break;
            									case (int)2: {
HXLINE( 405)										_this->s2 = v;
            									}
            									break;
            									case (int)3: {
HXLINE( 405)										_this->s3 = v;
            									}
            									break;
            									case (int)4: {
HXLINE( 405)										_this->s4 = v;
            									}
            									break;
            									case (int)5: {
HXLINE( 405)										_this->s5 = v;
            									}
            									break;
            									default:{
HXLINE( 405)										if (::hx::IsNull( _this->s6 )) {
HXLINE( 405)											_this->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            										}
HXDLIN( 405)										{
HXLINE( 405)											 ::justPath::StoreF6 _this1 = _this->s6;
HXDLIN( 405)											switch((int)(_this1->l)){
            												case (int)0: {
HXLINE( 405)													_this1->s0 = v;
            												}
            												break;
            												case (int)1: {
HXLINE( 405)													_this1->s1 = v;
            												}
            												break;
            												case (int)2: {
HXLINE( 405)													_this1->s2 = v;
            												}
            												break;
            												case (int)3: {
HXLINE( 405)													_this1->s3 = v;
            												}
            												break;
            												case (int)4: {
HXLINE( 405)													_this1->s4 = v;
            												}
            												break;
            												case (int)5: {
HXLINE( 405)													_this1->s5 = v;
            												}
            												break;
            												default:{
HXLINE( 405)													if (::hx::IsNull( _this1->s6 )) {
HXLINE( 405)														_this1->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            													}
HXDLIN( 405)													_this1->s6->push(v);
            												}
            											}
HXDLIN( 405)											_this1->l++;
            										}
...
HXLINE( 407)								 ::justPath::StoreF6 _this = this->store;
HXDLIN( 407)								 ::Dynamic v = ::Std_obj::parseFloat(temp);
HXDLIN( 407)								switch((int)(_this->l)){
            									case (int)0: {
HXLINE( 407)										_this->s0 = v;
            									}
            									break;
            									case (int)1: {
HXLINE( 407)										_this->s1 = v;
            									}
            									break;
            									case (int)2: {
HXLINE( 407)										_this->s2 = v;
            									}
            									break;
            									case (int)3: {
HXLINE( 407)										_this->s3 = v;
            									}
            									break;
            									case (int)4: {
HXLINE( 407)										_this->s4 = v;
            									}
            									break;
            									case (int)5: {
HXLINE( 407)										_this->s5 = v;
            									}
            									break;
            									default:{
HXLINE( 407)										if (::hx::IsNull( _this->s6 )) {
HXLINE( 407)											_this->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            										}
HXDLIN( 407)										{
HXLINE( 407)											 ::justPath::StoreF6 _this1 = _this->s6;
HXDLIN( 407)											switch((int)(_this1->l)){
            												case (int)0: {
HXLINE( 407)													_this1->s0 = v;
            												}
            												break;
            												case (int)1: {
HXLINE( 407)													_this1->s1 = v;
            												}
            												break;
            												case (int)2: {
HXLINE( 407)													_this1->s2 = v;
            												}
            												break;
            												case (int)3: {
HXLINE( 407)													_this1->s3 = v;
            												}
            												break;
            												case (int)4: {
HXLINE( 407)													_this1->s4 = v;
            												}
            												break;
            												case (int)5: {
HXLINE( 407)													_this1->s5 = v;
            												}
            												break;
            												default:{
HXLINE( 407)													if (::hx::IsNull( _this1->s6 )) {
HXLINE( 407)														_this1->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            													}
HXDLIN( 407)													_this1->s6->push(v);
            												}
            											}
HXDLIN( 407)											_this1->l++;
            										}
...
HXLINE( 410)							 ::justPath::StoreF6 _this = this->store;
HXDLIN( 410)							 ::Dynamic v = ::Std_obj::parseFloat(temp);
HXDLIN( 410)							switch((int)(_this->l)){
            								case (int)0: {
HXLINE( 410)									_this->s0 = v;
            								}
            								break;
            								case (int)1: {
HXLINE( 410)									_this->s1 = v;
            								}
            								break;
            								case (int)2: {
HXLINE( 410)									_this->s2 = v;
            								}
            								break;
            								case (int)3: {
HXLINE( 410)									_this->s3 = v;
            								}
            								break;
            								case (int)4: {
HXLINE( 410)									_this->s4 = v;
            								}
            								break;
            								case (int)5: {
HXLINE( 410)									_this->s5 = v;
            								}
            								break;
            								default:{
HXLINE( 410)									if (::hx::IsNull( _this->s6 )) {
HXLINE( 410)										_this->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            									}
HXDLIN( 410)									{
HXLINE( 410)										 ::justPath::StoreF6 _this1 = _this->s6;
HXDLIN( 410)										switch((int)(_this1->l)){
            											case (int)0: {
HXLINE( 410)												_this1->s0 = v;
            											}
            											break;
            											case (int)1: {
HXLINE( 410)												_this1->s1 = v;
            											}
            											break;
            											case (int)2: {
HXLINE( 410)												_this1->s2 = v;
            											}
            											break;
            											case (int)3: {
HXLINE( 410)												_this1->s3 = v;
            											}
            											break;
            											case (int)4: {
HXLINE( 410)												_this1->s4 = v;
            											}
            											break;
            											case (int)5: {
HXLINE( 410)												_this1->s5 = v;
            											}
            											break;
            											default:{
HXLINE( 410)												if (::hx::IsNull( _this1->s6 )) {
HXLINE( 410)													_this1->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            												}
HXDLIN( 410)												_this1->s6->push(v);
            											}
            										}
HXDLIN( 410)										_this1->l++;
            									}
...
HXLINE( 413)					temp = HX_("-",2d,00,00,00);
            				}
            				break;
            				case (int)46: {
HXLINE( 415)					temp = (temp + HX_(".",2e,00,00,00));
            				}
            				break;
            				case (int)48: {
HXLINE( 417)					temp = (temp + HX_("0",30,00,00,00));
            				}
            				break;
            				case (int)49: {
HXLINE( 419)					temp = (temp + HX_("1",31,00,00,00));
            				}
            				break;
            				case (int)50: {
HXLINE( 421)					temp = (temp + HX_("2",32,00,00,00));
            				}
            				break;
            				case (int)51: {
HXLINE( 423)					temp = (temp + HX_("3",33,00,00,00));
            				}
            				break;
            				case (int)52: {
HXLINE( 425)					temp = (temp + HX_("4",34,00,00,00));
            				}
            				break;
            				case (int)53: {
HXLINE( 427)					temp = (temp + HX_("5",35,00,00,00));
            				}
            				break;
            				case (int)54: {
HXLINE( 429)					temp = (temp + HX_("6",36,00,00,00));
            				}
            				break;
            				case (int)55: {
HXLINE( 431)					temp = (temp + HX_("7",37,00,00,00));
            				}
            				break;
            				case (int)56: {
HXLINE( 433)					temp = (temp + HX_("8",38,00,00,00));
            				}
            				break;
            				case (int)57: {
HXLINE( 435)					temp = (temp + HX_("9",39,00,00,00));
            				}
            				break;
            				default:{
HXLINE( 451)					if ((temp != HX_("",00,00,00,00))) {
HXLINE( 453)						if (( (bool)(process) )) {
HXLINE( 454)							if (((this->store->l & 1) == 0)) {
HXLINE( 455)								 ::justPath::StoreF6 _this = this->store;
HXDLIN( 455)								 ::Dynamic v = ::Std_obj::parseFloat(temp);
HXDLIN( 455)								switch((int)(_this->l)){
            									case (int)0: {
HXLINE( 455)										_this->s0 = v;
            									}
            									break;
            									case (int)1: {
HXLINE( 455)										_this->s1 = v;
            									}
            									break;
            									case (int)2: {
HXLINE( 455)										_this->s2 = v;
            									}
            									break;
            									case (int)3: {
HXLINE( 455)										_this->s3 = v;
            									}
            									break;
            									case (int)4: {
HXLINE( 455)										_this->s4 = v;
            									}
            									break;
            									case (int)5: {
HXLINE( 455)										_this->s5 = v;
            									}
            									break;
            									default:{
HXLINE( 455)										if (::hx::IsNull( _this->s6 )) {
HXLINE( 455)											_this->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            										}
HXDLIN( 455)										{
HXLINE( 455)											 ::justPath::StoreF6 _this1 = _this->s6;
HXDLIN( 455)											switch((int)(_this1->l)){
            												case (int)0: {
HXLINE( 455)													_this1->s0 = v;
            												}
            												break;
            												case (int)1: {
HXLINE( 455)													_this1->s1 = v;
            												}
            												break;
            												case (int)2: {
HXLINE( 455)													_this1->s2 = v;
            												}
            												break;
            												case (int)3: {
HXLINE( 455)													_this1->s3 = v;
            												}
            												break;
            												case (int)4: {
HXLINE( 455)													_this1->s4 = v;
            												}
            												break;
            												case (int)5: {
HXLINE( 455)													_this1->s5 = v;
            												}
            												break;
            												default:{
HXLINE( 455)													if (::hx::IsNull( _this1->s6 )) {
HXLINE( 455)														_this1->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            													}
HXDLIN( 455)													_this1->s6->push(v);
            												}
            											}
HXDLIN( 455)											_this1->l++;
            										}
...
HXLINE( 457)								 ::justPath::StoreF6 _this = this->store;
HXDLIN( 457)								 ::Dynamic v = ::Std_obj::parseFloat(temp);
HXDLIN( 457)								switch((int)(_this->l)){
            									case (int)0: {
HXLINE( 457)										_this->s0 = v;
            									}
            									break;
            									case (int)1: {
HXLINE( 457)										_this->s1 = v;
            									}
            									break;
            									case (int)2: {
HXLINE( 457)										_this->s2 = v;
            									}
            									break;
            									case (int)3: {
HXLINE( 457)										_this->s3 = v;
            									}
            									break;
            									case (int)4: {
HXLINE( 457)										_this->s4 = v;
            									}
            									break;
            									case (int)5: {
HXLINE( 457)										_this->s5 = v;
            									}
            									break;
            									default:{
HXLINE( 457)										if (::hx::IsNull( _this->s6 )) {
HXLINE( 457)											_this->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            										}
HXDLIN( 457)										{
HXLINE( 457)											 ::justPath::StoreF6 _this1 = _this->s6;
HXDLIN( 457)											switch((int)(_this1->l)){
            												case (int)0: {
HXLINE( 457)													_this1->s0 = v;
            												}
            												break;
            												case (int)1: {
HXLINE( 457)													_this1->s1 = v;
            												}
            												break;
            												case (int)2: {
HXLINE( 457)													_this1->s2 = v;
            												}
            												break;
            												case (int)3: {
HXLINE( 457)													_this1->s3 = v;
            												}
            												break;
            												case (int)4: {
HXLINE( 457)													_this1->s4 = v;
            												}
            												break;
            												case (int)5: {
HXLINE( 457)													_this1->s5 = v;
            												}
            												break;
            												default:{
HXLINE( 457)													if (::hx::IsNull( _this1->s6 )) {
HXLINE( 457)														_this1->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            													}
HXDLIN( 457)													_this1->s6->push(v);
            												}
            											}
HXDLIN( 457)											_this1->l++;
            										}
...
HXLINE( 460)							 ::justPath::StoreF6 _this = this->store;
HXDLIN( 460)							 ::Dynamic v = ::Std_obj::parseFloat(temp);
HXDLIN( 460)							switch((int)(_this->l)){
            								case (int)0: {
HXLINE( 460)									_this->s0 = v;
            								}
            								break;
            								case (int)1: {
HXLINE( 460)									_this->s1 = v;
            								}
            								break;
            								case (int)2: {
HXLINE( 460)									_this->s2 = v;
            								}
            								break;
            								case (int)3: {
HXLINE( 460)									_this->s3 = v;
            								}
            								break;
            								case (int)4: {
HXLINE( 460)									_this->s4 = v;
            								}
            								break;
            								case (int)5: {
HXLINE( 460)									_this->s5 = v;
            								}
            								break;
            								default:{
HXLINE( 460)									if (::hx::IsNull( _this->s6 )) {
HXLINE( 460)										_this->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            									}
HXDLIN( 460)									{
HXLINE( 460)										 ::justPath::StoreF6 _this1 = _this->s6;
HXDLIN( 460)										switch((int)(_this1->l)){
            											case (int)0: {
HXLINE( 460)												_this1->s0 = v;
            											}
            											break;
            											case (int)1: {
HXLINE( 460)												_this1->s1 = v;
            											}
            											break;
            											case (int)2: {
HXLINE( 460)												_this1->s2 = v;
            											}
            											break;
            											case (int)3: {
HXLINE( 460)												_this1->s3 = v;
            											}
            											break;
            											case (int)4: {
HXLINE( 460)												_this1->s4 = v;
            											}
            											break;
            											case (int)5: {
HXLINE( 460)												_this1->s5 = v;
            											}
            											break;
            											default:{
HXLINE( 460)												if (::hx::IsNull( _this1->s6 )) {
HXLINE( 460)													_this1->s6 =  ::justPath::StoreF6_obj::__alloc( HX_CTX );
            												}
HXDLIN( 460)												_this1->s6->push(v);
            											}
            										}
HXDLIN( 460)										_this1->l++;
            									}
...
HXLINE( 462)						temp = HX_("",00,00,00,00);
            					}
HXLINE( 466)					this->pos--;
HXLINE( 467)					exit = true;
            				}
            			}
HXLINE( 469)			if (exit) {
HXLINE( 469)				goto _hx_goto_40;
            			}
HXLINE( 470)			this->c = this->str.cca(this->pos++);
            		}
            		_hx_goto_40:;
            	}


HX_DEFINE_DYNAMIC_FUNC1(SvgPath_obj,extractArgs,(void))

int SvgPath_obj::nextChar(){
            	HX_STACKFRAME(&_hx_pos_0b1b2dc758b14196_474_nextChar)
HXDLIN( 474)		return this->str.cca(this->pos++);
            	}


HX_DEFINE_DYNAMIC_FUNC0(SvgPath_obj,nextChar,return )
...
::hx::Val SvgPath_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"extractArgs") ) { return ::hx::Val( extractArgs_dyn() ); }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"quickTriangle") ) { return ::hx::Val( quickTriangle_dyn() ); }
	}
...
static ::String SvgPath_obj_sMemberFields[] = {
	...
	HX_("quickTriangle",d5,36,d9,a0),
	HX_("parse",33,90,55,bd),
	HX_("extractArgs",3e,a3,42,55),
