...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TrilateralLimeRegularColor", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		#if !munit
		var app = new Main();
		app.meta.set("build", "10");
		app.meta.set("company", "Nanjizal");
		app.meta.set("file", "TrilateralLimeRegularColor");
		app.meta.set("name", "TrilateralLimeRegularColor");
		app.meta.set("packageName", "net.nanjizal.trilateralLimeRegularColor");
		...
		var attributes:lime.ui.WindowAttributes =
			{
				...
				parameters: {},
				resizable: true,
				title: "TrilateralLimeRegularColor",
				width: 1000,
				x: null,
				y: null,
			};
