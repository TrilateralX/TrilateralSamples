...
HXLINE(  12)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("TrilateralLimeRegularColor",08,91,03,45),::ApplicationMain_obj::create_dyn());
...
HXLINE(  27)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("TrilateralLimeRegularColor",08,91,03,45));
HXLINE(  28)		app->meta->set(HX_("name",4b,72,ff,48),HX_("TrilateralLimeRegularColor",08,91,03,45));
HXLINE(  29)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("net.nanjizal.trilateralLimeRegularColor",1a,c0,5b,dd));
...
HXLINE(  34)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("TrilateralLimeRegularColor",08,91,03,45))
