...
HX_LOCAL_STACK_FRAME(_hx_pos_fb83b890896e3f0e_15_clone,"trilateral3.structure.RegularShape","clone",0xd4f42d96,"trilateral3.structure.RegularShape.clone","trilateral3/structure/RegularShape.hx",15,0x99462235)
...
bool RegularShape_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::trilateral3::structure::RegularShape RegularShape_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_fb83b890896e3f0e_15_clone)
HXDLIN(  15)		return  ::trilateral3::structure::RegularShape_obj::__alloc( HX_CTX ,this->x,this->y,this->radius,this->color);
            	}


HX_DEFINE_DYNAMIC_FUNC0(RegularShape_obj,clone,return )
