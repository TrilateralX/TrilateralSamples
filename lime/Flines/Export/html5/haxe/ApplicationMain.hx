...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TrilateralLimeLines", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		app.meta.set("file", "TrilateralLimeLines");
		app.meta.set("name", "TrilateralLimeLines");
		app.meta.set("packageName", "net.nanjizal.trilateralLimeLines");
