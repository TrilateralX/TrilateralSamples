...
HXLINE(  12)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("TrilateralLimeLines",3e,a4,1a,35),::ApplicationMain_obj::create_dyn());
...
HXLINE(  27)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("TrilateralLimeLines",3e,a4,1a,35));
HXLINE(  28)		app->meta->set(HX_("name",4b,72,ff,48),HX_("TrilateralLimeLines",3e,a4,1a,35));
HXLINE(  29)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("net.nanjizal.trilateralLimeLines",ec,46,64,d4));
...
HXLINE(  34)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("TrilateralLimeLines",3e,a4,1a,35))
