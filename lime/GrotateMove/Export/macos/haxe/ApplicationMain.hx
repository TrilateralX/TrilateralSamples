...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TrilateralLimeRotateMove", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		app.meta.set("file", "TrilateralLimeRotateMove");
		app.meta.set("name", "TrilateralLimeRotateMove");
		app.meta.set("packageName", "net.nanjizal.trilateralLimeRotateMove");
		...
		var attributes:lime.ui.WindowAttributes =
			{
				...
				parameters: {},
				resizable: true,
				title: "TrilateralLimeRotateMove",
				width: 1000,
				x: null,
				y: null,
			};
