...
class ApplicationMain
{
   ...
   public static function main()
   {
      ...
      if (closePreloader!=null)
         ...
         nme.app.Application.setPackage("Nanjizal", "Application", "net.trilateralX.TrilateralnmeTriangle", "0.0.1");
         #if HXCPP_TELEMETRY
         ...
         else
         {
            wx.App.boot(function()
            {
               var size = { width: 1000, height: 1000 };
                  ...
                  frame = wx.Frame.create(null, null, "TrilateralnmeTriangle", null, size);
               
               nme.Lib.title = "TrilateralnmeTriangle";
         ...
         ;
            ...
            nme.app.Application.createWindow(function(window:nme.app.Window) {
               new TrilateralnmeTriangle(window);
            }, params );
