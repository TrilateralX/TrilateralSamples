...
HXLINE( 201)			if (::hx::IsInstanceEq( child->stage,child )) {
...
HXLINE( 214)		if (::hx::IsInstanceEq( child->parent,::hx::ObjectPtr<OBJ_>(this) )) {
HXLINE( 216)			if (::hx::IsInstanceNotEq( this->_hx___children->__get(index).StaticCast<  ::openfl::display::DisplayObject >(),child )) {
...
HXDLIN( 320)			if (::hx::IsInstanceNotEq( child,::hx::ObjectPtr<OBJ_>(this) )) {
...
HXLINE( 322)			child = child->parent;
            		...
            		_hx_goto_4:;
HXLINE( 325)		return ::hx::IsInstanceEq( child,::hx::ObjectPtr<OBJ_>(this) );
            	}
...
HXLINE( 391)				if (::hx::IsInstanceEq( this->_hx___children->__get(i).StaticCast<  ::openfl::display::DisplayObject >(),child )) {
HXLINE( 391)					return i;
            				}
            			}
            		}
...
HXLINE( 445)			_hx_tmp = ::hx::IsInstanceEq( child->parent,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
...
HXLINE( 456)					_hx_tmp = ::hx::IsInstanceEq( this->stage->get_focus(),child );
            				}
            				else {
...
HXDLIN( 601)			_hx_tmp = ::hx::IsInstanceEq( child->parent,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
...
HXDLIN( 634)		if (::hx::IsInstanceEq( child1->parent,::hx::ObjectPtr<OBJ_>(this) )) {
HXDLIN( 634)			_hx_tmp = ::hx::IsInstanceEq( child2->parent,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
