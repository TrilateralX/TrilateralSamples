...
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_205_new,"openfl.display.Stage3D","new",0x52647737,"openfl.display.Stage3D.new","openfl/display/Stage3D.hx",205,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_285_requestContext3D,"openfl.display.Stage3D","requestContext3D",0x80c219da,"openfl.display.Stage3D.requestContext3D","openfl/display/Stage3D.hx",285,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_365_requestContext3DMatchingProfiles,"openfl.display.Stage3D","requestContext3DMatchingProfiles",0x5b5ae301,"openfl.display.Stage3D.requestContext3DMatchingProfiles","openfl/display/Stage3D.hx",365,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_369___createContext,"openfl.display.Stage3D","__createContext",0x1987b48a,"openfl.display.Stage3D.__createContext","openfl/display/Stage3D.hx",369,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_451___dispatchError,"openfl.display.Stage3D","__dispatchError",0xdb9710e5,"openfl.display.Stage3D.__dispatchError","openfl/display/Stage3D.hx",451,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_458___dispatchCreate,"openfl.display.Stage3D","__dispatchCreate",0x733e9b3f,"openfl.display.Stage3D.__dispatchCreate","openfl/display/Stage3D.hx",458,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_466___lostContext,"openfl.display.Stage3D","__lostContext",0x951652e2,"openfl.display.Stage3D.__lostContext","openfl/display/Stage3D.hx",466,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_478___resize,"openfl.display.Stage3D","__resize",0x193af2dd,"openfl.display.Stage3D.__resize","openfl/display/Stage3D.hx",478,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_502___restoreContext,"openfl.display.Stage3D","__restoreContext",0xa732262a,"openfl.display.Stage3D.__restoreContext","openfl/display/Stage3D.hx",502,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_509_get_x,"openfl.display.Stage3D","get_x",0x0609efe6,"openfl.display.Stage3D.get_x","openfl/display/Stage3D.hx",509,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_513_set_x,"openfl.display.Stage3D","set_x",0xeed8e5f2,"openfl.display.Stage3D.set_x","openfl/display/Stage3D.hx",513,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_524_get_y,"openfl.display.Stage3D","get_y",0x0609efe7,"openfl.display.Stage3D.get_y","openfl/display/Stage3D.hx",524,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_528_set_y,"openfl.display.Stage3D","set_y",0xeed8e5f3,"openfl.display.Stage3D.set_y","openfl/display/Stage3D.hx",528,0x37141b9b)
namespace openfl{
namespace display{

void Stage3D_obj::__construct( ::openfl::display::Stage stage){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_205_new)
HXLINE( 206)		super::__construct(null());
HXLINE( 208)		this->_hx___stage = stage;
HXLINE( 210)		this->_hx___height = 0;
HXLINE( 211)		this->_hx___projectionTransform =  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,null());
HXLINE( 212)		this->_hx___renderTransform =  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,null());
HXLINE( 213)		this->_hx___width = 0;
HXLINE( 214)		this->_hx___x = ( (Float)(0) );
HXLINE( 215)		this->_hx___y = ( (Float)(0) );
HXLINE( 217)		this->visible = true;
HXLINE( 219)		bool _hx_tmp;
HXDLIN( 219)		if ((stage->stageWidth > 0)) {
HXLINE( 219)			_hx_tmp = (stage->stageHeight > 0);
            		}
            		else {
HXLINE( 219)			_hx_tmp = false;
            		}
HXDLIN( 219)		if (_hx_tmp) {
HXLINE( 221)			this->_hx___resize(stage->stageWidth,stage->stageHeight);
            		}
            	}
...
void Stage3D_obj::requestContext3D( ::Dynamic __o_context3DRenderMode, ::Dynamic __o_profile){
            	...
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_285_requestContext3D)
HXLINE( 286)		if (this->_hx___contextLost) {
HXLINE( 288)			this->_hx___contextRequested = true;
HXLINE( 289)			return;
            		}
HXLINE( 292)		if (::hx::IsNotNull( this->context3D )) {
HXLINE( 294)			this->_hx___contextRequested = true;
HXLINE( 295)			::haxe::Timer_obj::delay(this->_hx___dispatchCreate_dyn(),1);
            		}
            		else {
HXLINE( 297)			if (!(this->_hx___contextRequested)) {
HXLINE( 299)				this->_hx___contextRequested = true;
HXLINE( 300)				::haxe::Timer_obj::delay(this->_hx___createContext_dyn(),1);
            			}
            		}
            	}
...
void Stage3D_obj::requestContext3DMatchingProfiles( ::openfl::_Vector::ObjectVector profiles){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_365_requestContext3DMatchingProfiles)
HXDLIN( 365)		this->requestContext3D(null(),null());
            	}
...
void Stage3D_obj::_hx___createContext(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_369___createContext)
HXLINE( 371)		 ::openfl::display::Stage stage = this->_hx___stage;
HXLINE( 372)		 ::openfl::display::DisplayObjectRenderer renderer = stage->_hx___renderer;
HXLINE( 374)		bool _hx_tmp;
HXDLIN( 374)		if ((renderer->_hx___type != HX_("cairo",88,30,19,41))) {
HXLINE( 374)			_hx_tmp = (renderer->_hx___type == HX_("canvas",d8,54,42,b8));
            		}
            		else {
HXLINE( 374)			_hx_tmp = true;
            		}
HXDLIN( 374)		if (_hx_tmp) {
HXLINE( 376)			this->_hx___dispatchError();
HXLINE( 377)			return;
            		}
HXLINE( 380)		if ((renderer->_hx___type == HX_("opengl",6f,64,94,21))) {
HXLINE( 385)			this->context3D =  ::openfl::display3D::Context3D_obj::__alloc( HX_CTX ,stage,stage->context3D->_hx___contextState,::hx::ObjectPtr<OBJ_>(this));
HXLINE( 387)			this->_hx___dispatchCreate();
            		}
            		else {
HXLINE( 389)			bool _hx_tmp = (renderer->_hx___type == HX_("dom",82,42,4c,00));
            		}
            	}
...
void Stage3D_obj::_hx___dispatchError(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_451___dispatchError)
HXLINE( 452)		this->_hx___contextRequested = false;
HXLINE( 453)		this->dispatchEvent( ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,HX_("error",c8,cb,29,73),false,false,HX_("Context3D not available",9c,fc,63,d3),null()));
            	}
...
void Stage3D_obj::_hx___dispatchCreate(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_458___dispatchCreate)
HXDLIN( 458)		if (this->_hx___contextRequested) {
HXLINE( 460)			this->_hx___contextRequested = false;
HXLINE( 461)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("context3DCreate",7c,bf,59,7b),null(),null()));
            		}
            	}
...
void Stage3D_obj::_hx___lostContext(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_466___lostContext)
HXLINE( 467)		this->_hx___contextLost = true;
HXLINE( 469)		if (::hx::IsNotNull( this->context3D )) {
HXLINE( 471)			this->context3D->_hx___dispose();
HXLINE( 472)			this->_hx___contextRequested = true;
            		}
            	}
...
void Stage3D_obj::_hx___resize(int width,int height){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_478___resize)
HXDLIN( 478)		bool _hx_tmp;
HXDLIN( 478)		if ((width == this->_hx___width)) {
HXDLIN( 478)			_hx_tmp = (height != this->_hx___height);
            		}
            		else {
HXDLIN( 478)			_hx_tmp = true;
            		}
HXDLIN( 478)		if (_hx_tmp) {
HXLINE( 488)			 ::openfl::geom::Matrix3D _hx_tmp = this->_hx___projectionTransform;
HXDLIN( 488)			int length = null();
HXDLIN( 488)			bool fixed = null();
HXLINE( 489)			int _hx_tmp1;
HXDLIN( 489)			if ((width > 0)) {
HXLINE( 489)				_hx_tmp1 = width;
            			}
            			else {
HXLINE( 489)				_hx_tmp1 = 1;
            			}
HXDLIN( 489)			int _hx_tmp2;
HXDLIN( 489)			if ((height > 0)) {
HXLINE( 489)				_hx_tmp2 = height;
            			}
            			else {
HXLINE( 489)				_hx_tmp2 = 1;
            			}
HXLINE( 488)			_hx_tmp->copyRawDataFrom( ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,::Array_obj< Float >::__new(16)->init(0,(((Float)2.0) / ( (Float)(_hx_tmp1) )))->init(1,((Float)0.0))->init(2,((Float)0.0))->init(3,((Float)0.0))->init(4,((Float)0.0))->init(5,(((Float)-2.0) / ( (Float)(_hx_tmp2) )))->init(6,((Float)0.0))->init(7,((Float)0.0))->init(8,((Float)0.0))->init(9,((Float)0.0))->init(10,((Float)-0.001))->init(11,((Float)0.0))->init(12,((Float)-1.0))->init(13,((Float)1.0))->init(14,((Float)0.0))->init(15,((Float)1.0)),true),null(),null());
HXLINE( 492)			this->_hx___renderTransform->identity();
HXLINE( 493)			this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,( (Float)(0) ));
HXLINE( 494)			this->_hx___renderTransform->append(this->_hx___projectionTransform);
HXLINE( 496)			this->_hx___width = width;
HXLINE( 497)			this->_hx___height = height;
            		}
            	}
...
void Stage3D_obj::_hx___restoreContext(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_502___restoreContext)
HXLINE( 503)		this->_hx___contextLost = false;
HXLINE( 504)		this->_hx___createContext();
            	}
...
Float Stage3D_obj::get_x(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_509_get_x)
HXDLIN( 509)		return this->_hx___x;
            	}
...
Float Stage3D_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_513_set_x)
HXLINE( 514)		if ((this->_hx___x == value)) {
HXLINE( 514)			return value;
            		}
HXLINE( 515)		this->_hx___x = value;
HXLINE( 516)		this->_hx___renderTransform->identity();
HXLINE( 517)		this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,( (Float)(0) ));
HXLINE( 518)		this->_hx___renderTransform->append(this->_hx___projectionTransform);
...
Float Stage3D_obj::get_y(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_524_get_y)
HXDLIN( 524)		return this->_hx___y;
            	}
...
Float Stage3D_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_528_set_y)
HXLINE( 529)		if ((this->_hx___y == value)) {
HXLINE( 529)			return value;
            		}
HXLINE( 530)		this->_hx___y = value;
HXLINE( 531)		this->_hx___renderTransform->identity();
HXLINE( 532)		this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,( (Float)(0) ));
HXLINE( 533)		this->_hx___renderTransform->append(this->_hx___projectionTransform);
