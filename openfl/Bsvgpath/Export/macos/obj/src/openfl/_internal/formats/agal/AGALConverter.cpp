...
HXLINE(  30)				return HX_("va",2b,67,00,00);
            			...
            			break;
            			case (int)1: {
HXLINE(  32)				if (::hx::IsPointerEq( programType,::openfl::_internal::formats::agal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
...
HXLINE(  32)					return HX_("fc",3d,59,00,00);
            			...
            			break;
            			case (int)2: {
HXLINE(  34)				if (::hx::IsPointerEq( programType,::openfl::_internal::formats::agal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
...
HXDLIN( 278)					if (::hx::IsPointerNotEq( existingUsage,::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn() )) {
HXLINE( 278)						_hx_tmp = ::hx::IsPointerNotEq( existingUsage,::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage_obj::VECTOR_4_ARRAY_dyn() );
            					}
            					else {
...
HXDLIN( 309)					if (::hx::IsPointerNotEq( existingUsage,::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn() )) {
HXLINE( 309)						_hx_tmp = ::hx::IsPointerNotEq( existingUsage,::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage_obj::VECTOR_4_ARRAY_dyn() );
            					}
            					else {
...
HXDLIN( 344)					if (::hx::IsPointerNotEq( existingUsage,::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn() )) {
HXLINE( 344)						_hx_tmp = ::hx::IsPointerNotEq( existingUsage,::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage_obj::VECTOR_4_ARRAY_dyn() );
            					}
            					else {
...
HXLINE( 486)		{
HXLINE( 486)			::String x;
HXDLIN( 486)			if (::hx::IsPointerEq( programType,::openfl::_internal::formats::agal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
...
HXLINE( 506)		if (::hx::IsPointerEq( programType,::openfl::_internal::formats::agal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
...
HXLINE( 516)		if (::hx::IsPointerEq( programType,::openfl::_internal::formats::agal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
