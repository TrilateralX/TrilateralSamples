...
HX_DEFINE_STACK_FRAME(_hx_pos_7545faed7dab6ee1_133_new,"openfl.filters.ColorMatrixFilter","new",0x2c3a675d,"openfl.filters.ColorMatrixFilter.new","openfl/filters/ColorMatrixFilter.hx",133,0xb64128b5)
HX_LOCAL_STACK_FRAME(_hx_pos_7545faed7dab6ee1_144_clone,"openfl.filters.ColorMatrixFilter","clone",0x2c5b239a,"openfl.filters.ColorMatrixFilter.clone","openfl/filters/ColorMatrixFilter.hx",144,0xb64128b5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7545faed7dab6ee1_218___initShader,"openfl.filters.ColorMatrixFilter","__initShader",0x2d28b6d8,"openfl.filters.ColorMatrixFilter.__initShader","openfl/filters/ColorMatrixFilter.hx",218,0xb64128b5)
HX_LOCAL_STACK_FRAME(_hx_pos_7545faed7dab6ee1_226_get_matrix,"openfl.filters.ColorMatrixFilter","get_matrix",0x7ee298ad,"openfl.filters.ColorMatrixFilter.get_matrix","openfl/filters/ColorMatrixFilter.hx",226,0xb64128b5)
HX_LOCAL_STACK_FRAME(_hx_pos_7545faed7dab6ee1_230_set_matrix,"openfl.filters.ColorMatrixFilter","set_matrix",0x82603721,"openfl.filters.ColorMatrixFilter.set_matrix","openfl/filters/ColorMatrixFilter.hx",230,0xb64128b5)
...
void ColorMatrixFilter_obj::__construct(::Array< Float > matrix){
            	HX_STACKFRAME(&_hx_pos_7545faed7dab6ee1_133_new)
HXLINE( 134)		super::__construct();
HXLINE( 136)		this->set_matrix(matrix);
HXLINE( 138)		this->_hx___numShaderPasses = 1;
HXLINE( 139)		this->_hx___needSecondBitmapData = false;
            	}
...
bool ColorMatrixFilter_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::filters::BitmapFilter ColorMatrixFilter_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_7545faed7dab6ee1_144_clone)
HXDLIN( 144)		return  ::openfl::filters::ColorMatrixFilter_obj::__alloc( HX_CTX ,this->_hx___matrix);
            	}
...
HXLINE( 177)				{
HXLINE( 177)					int _g1 = ::Std_obj::_hx_int(sourceRect->x);
HXDLIN( 177)					int _g2 = ::Std_obj::_hx_int(sourceRect->width);
HXDLIN( 177)					while((_g1 < _g2)){
HXLINE( 177)						_g1 = (_g1 + 1);
HXDLIN( 177)						int column = (_g1 - 1);
...
HXDLIN( 182)									sourcePixel = (((((r & 255) << 24) | ((g & 255) << 16)) | ((b & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 3))) & 255)) ) & 255));
            								...
            								break;
            								case (int)1: {
HXLINE( 182)									int r = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 1))) & 255)) );
HXDLIN( 182)									int g = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 2))) & 255)) );
HXDLIN( 182)									int b = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 3))) & 255)) );
HXDLIN( 182)									sourcePixel = (((((r & 255) << 24) | ((g & 255) << 16)) | ((b & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + sourceOffset)) & 255)) ) & 255));
            								}
            								break;
            								case (int)2: {
HXLINE( 182)									int r = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 2))) & 255)) );
HXDLIN( 182)									int g = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 1))) & 255)) );
HXDLIN( 182)									int b = ( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + sourceOffset)) & 255)) );
HXDLIN( 182)									sourcePixel = (((((r & 255) << 24) | ((g & 255) << 16)) | ((b & 255) << 8)) | (( (int)(( ::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + (sourceOffset + 3))) & 255)) ) & 255));
            								}
            								break;
            							}
...
HXDLIN( 182)										int r = ( (int)(( ::__hxcpp_memory_get_byte(this1->buffer->b,(this1->byteOffset + ::Math_obj::round((( (Float)((::hx::UShr(sourcePixel,24) & 255)) ) * ::lime::math::_RGBA::RGBA_Impl__obj::unmult)))) & 255)) );
HXDLIN( 182)										 ::lime::utils::ArrayBufferView this2 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN( 182)										int g = ( (int)(( ::__hxcpp_memory_get_byte(this2->buffer->b,(this2->byteOffset + ::Math_obj::round((( (Float)((::hx::UShr(sourcePixel,16) & 255)) ) * ::lime::math::_RGBA::RGBA_Impl__obj::unmult)))) & 255)) );
HXDLIN( 182)										 ::lime::utils::ArrayBufferView this3 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN( 182)										sourcePixel = (((((r & 255) << 24) | ((g & 255) << 16)) | ((( (int)(( ::__hxcpp_memory_get_byte(this3->buffer->b,(this3->byteOffset + ::Math_obj::round((( (Float)((::hx::UShr(sourcePixel,8) & 255)) ) * ::lime::math::_RGBA::RGBA_Impl__obj::unmult)))) & 255)) ) & 255) << 8)) | ((sourcePixel & 255) & 255));
            									}
            								}
            							}
            						}
...
HXLINE( 194)							{
HXLINE( 194)								int value1 = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(0) ),::Math_obj::min((((((this->_hx___matrix->__get(5) * ( (Float)((::hx::UShr(sourcePixel,24) & 255)) )) + (this->_hx___matrix->__get(6) * ( (Float)((::hx::UShr(sourcePixel,16) & 255)) ))) + (this->_hx___matrix->__get(7) * ( (Float)((::hx::UShr(sourcePixel,8) & 255)) ))) + (this->_hx___matrix->__get(8) * ( (Float)((sourcePixel & 255)) ))) + this->_hx___matrix->__get(9)),( (Float)(255) ))));
HXDLIN( 194)								destPixel = ((((((::hx::UShr(destPixel,24) & 255) & 255) << 24) | ((value1 & 255) << 16)) | (((::hx::UShr(destPixel,8) & 255) & 255) << 8)) | ((destPixel & 255) & 255));
            							}
HXLINE( 198)							{
...
HXDLIN( 198)								destPixel = ((((((::hx::UShr(destPixel,24) & 255) & 255) << 24) | (((::hx::UShr(destPixel,16) & 255) & 255) << 16)) | ((value2 & 255) << 8)) | ((destPixel & 255) & 255));
            							}
HXLINE( 202)							{
HXLINE( 202)								int value3 = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(0) ),::Math_obj::min((((((this->_hx___matrix->__get(15) * ( (Float)((::hx::UShr(sourcePixel,24) & 255)) )) + (this->_hx___matrix->__get(16) * ( (Float)((::hx::UShr(sourcePixel,16) & 255)) ))) + (this->_hx___matrix->__get(17) * ( (Float)((::hx::UShr(sourcePixel,8) & 255)) ))) + (this->_hx___matrix->__get(18) * ( (Float)((sourcePixel & 255)) ))) + this->_hx___matrix->__get(19)),( (Float)(255) ))));
HXDLIN( 202)								destPixel = ((((((::hx::UShr(destPixel,24) & 255) & 255) << 24) | (((::hx::UShr(destPixel,16) & 255) & 255) << 16)) | (((::hx::UShr(destPixel,8) & 255) & 255) << 8)) | (value3 & 255));
            							}
            						}
HXLINE( 208)						{
HXLINE( 208)							if (destPremultiplied) {
HXLINE( 208)								if (((destPixel & 255) == 0)) {
HXLINE( 208)									if ((destPixel != 0)) {
HXLINE( 208)										destPixel = 0;
            									}
            								}
            								else {
HXLINE( 208)									if (((destPixel & 255) != 255)) {
HXLINE( 208)										 ::lime::utils::ArrayBufferView this1 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___alpha16;
HXDLIN( 208)										::lime::math::_RGBA::RGBA_Impl__obj::a16 = ( (int)( ::__hxcpp_memory_get_ui32(this1->buffer->b,(this1->byteOffset + ((destPixel & 255) * 4)))) );
HXDLIN( 208)										destPixel = ((((((((::hx::UShr(destPixel,24) & 255) * ::lime::math::_RGBA::RGBA_Impl__obj::a16) >> 16) & 255) << 24) | (((((::hx::UShr(destPixel,16) & 255) * ::lime::math::_RGBA::RGBA_Impl__obj::a16) >> 16) & 255) << 16)) | (((((::hx::UShr(destPixel,8) & 255) * ::lime::math::_RGBA::RGBA_Impl__obj::a16) >> 16) & 255) << 8)) | ((destPixel & 255) & 255));
            									}
            								}
            							}
HXDLIN( 208)							switch((int)(destFormat)){
            								case (int)0: {
HXLINE( 208)									{
HXLINE( 208)										int val = (::hx::UShr(destPixel,24) & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),val);
            									}
HXDLIN( 208)									{
HXLINE( 208)										int val1 = (::hx::UShr(destPixel,16) & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 1)),val1);
            									}
HXDLIN( 208)									{
HXLINE( 208)										int val2 = (::hx::UShr(destPixel,8) & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 2)),val2);
            									}
HXDLIN( 208)									{
HXLINE( 208)										int val3 = (destPixel & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),val3);
            									}
            								}
            								break;
            								case (int)1: {
HXLINE( 208)									{
HXLINE( 208)										int val = (destPixel & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),val);
            									}
HXDLIN( 208)									{
HXLINE( 208)										int val1 = (::hx::UShr(destPixel,24) & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 1)),val1);
            									}
HXDLIN( 208)									{
HXLINE( 208)										int val2 = (::hx::UShr(destPixel,16) & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 2)),val2);
            									}
HXDLIN( 208)									{
HXLINE( 208)										int val3 = (::hx::UShr(destPixel,8) & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),val3);
            									}
            								}
            								break;
            								case (int)2: {
HXLINE( 208)									{
HXLINE( 208)										int val = (::hx::UShr(destPixel,8) & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),val);
            									}
HXDLIN( 208)									{
HXLINE( 208)										int val1 = (::hx::UShr(destPixel,16) & 255);
...
HXDLIN( 208)									{
HXLINE( 208)										int val2 = (::hx::UShr(destPixel,24) & 255);
HXDLIN( 208)										 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 2)),val2);
            									}
HXDLIN( 208)									{
HXLINE( 208)										int val3 = (destPixel & 255);
...
HXLINE( 212)		destBitmapData->image->dirty = true;
HXLINE( 214)		return destBitmapData;
            	}
 ...
 ::openfl::display::Shader ColorMatrixFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass, ::openfl::display::BitmapData sourceBitmapData){
            	HX_STACKFRAME(&_hx_pos_7545faed7dab6ee1_218___initShader)
HXLINE( 219)		 ::openfl::filters::_ColorMatrixFilter::ColorMatrixShader _hx_tmp = ::openfl::filters::ColorMatrixFilter_obj::_hx___colorMatrixShader;
HXDLIN( 219)		_hx_tmp->init(this->get_matrix());
HXLINE( 220)		return ::openfl::filters::ColorMatrixFilter_obj::_hx___colorMatrixShader;
            	}


::Array< Float > ColorMatrixFilter_obj::get_matrix(){
            	HX_STACKFRAME(&_hx_pos_7545faed7dab6ee1_226_get_matrix)
HXDLIN( 226)		return this->_hx___matrix;
            	}
...
::Array< Float > ColorMatrixFilter_obj::set_matrix(::Array< Float > value){
            	HX_STACKFRAME(&_hx_pos_7545faed7dab6ee1_230_set_matrix)
HXLINE( 231)		if (::hx::IsNull( value )) {
HXLINE( 233)			value = ::Array_obj< Float >::fromData( _hx_array_data_760a74eb_8,20);
            		}
HXLINE( 236)		return (this->_hx___matrix = value);
            	}
