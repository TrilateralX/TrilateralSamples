...
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_194_get_colorTransform,"openfl.geom.Transform","get_colorTransform",0xc8c832c8,"openfl.geom.Transform.get_colorTransform","openfl/geom/Transform.hx",194,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_198_set_colorTransform,"openfl.geom.Transform","set_colorTransform",0xa577653c,"openfl.geom.Transform.set_colorTransform","openfl/geom/Transform.hx",198,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_215_get_concatenatedMatrix,"openfl.geom.Transform","get_concatenatedMatrix",0x352d276f,"openfl.geom.Transform.get_concatenatedMatrix","openfl/geom/Transform.hx",215,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_225_get_matrix,"openfl.geom.Transform","get_matrix",0x80c3ba80,"openfl.geom.Transform.get_matrix","openfl/geom/Transform.hx",225,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_235_set_matrix,"openfl.geom.Transform","set_matrix",0x844158f4,"openfl.geom.Transform.set_matrix","openfl/geom/Transform.hx",235,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_254_get_matrix3D,"openfl.geom.Transform","get_matrix3D",0x05078731,"openfl.geom.Transform.get_matrix3D","openfl/geom/Transform.hx",254,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_267_set_matrix3D,"openfl.geom.Transform","set_matrix3D",0x1a00aaa5,"openfl.geom.Transform.set_matrix3D","openfl/geom/Transform.hx",267,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_284___setTransform,"openfl.geom.Transform","__setTransform",0x9df9f800,"openfl.geom.Transform.__setTransform","openfl/geom/Transform.hx",284,0xf4f475e6)
namespace openfl{
namespace geom{
...
HXLINE( 162)		this->_hx___colorTransform =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 163)		this->concatenatedColorTransform =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 164)		this->pixelBounds =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE( 166)		this->_hx___displayObject = displayObject;
HXLINE( 167)		this->_hx___hasMatrix = true;
            	}
...
bool Transform_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::geom::ColorTransform Transform_obj::get_colorTransform(){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_194_get_colorTransform)
HXDLIN( 194)		return this->_hx___colorTransform;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_colorTransform,return )
 ...
 ::openfl::geom::ColorTransform Transform_obj::set_colorTransform( ::openfl::geom::ColorTransform value){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_198_set_colorTransform)
HXLINE( 199)		if (!(this->_hx___colorTransform->_hx___equals(value,false))) {
HXLINE( 201)			this->_hx___colorTransform->_hx___copyFrom(value);
HXLINE( 203)			if (::hx::IsNotNull( value )) {
HXLINE( 205)				this->_hx___displayObject->set_alpha(value->alphaMultiplier);
            			}
HXLINE( 208)			{
HXLINE( 208)				 ::openfl::display::DisplayObject _this = this->_hx___displayObject;
HXDLIN( 208)				if (!(_this->_hx___renderDirty)) {
HXLINE( 208)					_this->_hx___renderDirty = true;
HXDLIN( 208)					_this->_hx___setParentRenderDirty();
            				}
            			}
            		}
HXLINE( 211)		return this->_hx___colorTransform;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Transform_obj,set_colorTransform,return )
 ...
 ::openfl::geom::Matrix Transform_obj::get_concatenatedMatrix(){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_215_get_concatenatedMatrix)
HXLINE( 216)		if (this->_hx___hasMatrix) {
HXLINE( 218)			return this->_hx___displayObject->_hx___getWorldTransform()->clone();
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_concatenatedMatrix,return )
 ...
 ::openfl::geom::Matrix Transform_obj::get_matrix(){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_225_get_matrix)
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_matrix,return )
 ...
 ::openfl::geom::Matrix Transform_obj::set_matrix( ::openfl::geom::Matrix value){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_235_set_matrix)
HXLINE( 236)		if (::hx::IsNull( value )) {
HXLINE( 238)			this->_hx___hasMatrix = false;
HXLINE( 239)			return null();
            		}
HXLINE( 242)		this->_hx___hasMatrix = true;
HXLINE( 243)		this->_hx___hasMatrix3D = false;
HXLINE( 245)		if (::hx::IsNotNull( this->_hx___displayObject )) {
HXLINE( 247)			this->_hx___setTransform(value->a,value->b,value->c,value->d,value->tx,value->ty);
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_matrix3D,return )
 ...
 ::openfl::geom::Matrix3D Transform_obj::set_matrix3D( ::openfl::geom::Matrix3D value){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_267_set_matrix3D)
HXLINE( 268)		if (::hx::IsNull( value )) {
HXLINE( 270)			this->_hx___hasMatrix3D = false;
HXLINE( 271)			return null();
            		}
HXLINE( 274)		this->_hx___hasMatrix = false;
HXLINE( 275)		this->_hx___hasMatrix3D = true;
HXLINE( 277)		Float _hx_tmp = value->rawData->get(0);
HXDLIN( 277)		Float _hx_tmp1 = value->rawData->get(1);
HXDLIN( 277)		Float _hx_tmp2 = value->rawData->get(5);
HXDLIN( 277)		Float _hx_tmp3 = value->rawData->get(6);
HXDLIN( 277)		Float _hx_tmp4 = value->rawData->get(12);
HXDLIN( 277)		this->_hx___setTransform(_hx_tmp,_hx_tmp1,_hx_tmp2,_hx_tmp3,_hx_tmp4,value->rawData->get(13));
...
void Transform_obj::_hx___setTransform(Float a,Float b,Float c,Float d,Float tx,Float ty){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_284___setTransform)
HXDLIN( 284)		if (::hx::IsNotNull( this->_hx___displayObject )) {
HXLINE( 286)			 ::openfl::geom::Matrix transform = this->_hx___displayObject->_hx___transform;
HXLINE( 287)			bool _hx_tmp;
HXDLIN( 287)			bool _hx_tmp1;
HXDLIN( 287)			bool _hx_tmp2;
HXDLIN( 287)			bool _hx_tmp3;
HXDLIN( 287)			bool _hx_tmp4;
HXDLIN( 287)			if ((transform->a == a)) {
HXLINE( 287)				_hx_tmp4 = (transform->b == b);
            			}
            			else {
HXLINE( 287)				_hx_tmp4 = false;
            			}
HXDLIN( 287)			if (_hx_tmp4) {
HXLINE( 287)				_hx_tmp3 = (transform->c == c);
            			}
            			else {
HXLINE( 287)				_hx_tmp3 = false;
            			}
HXDLIN( 287)			if (_hx_tmp3) {
HXLINE( 287)				_hx_tmp2 = (transform->d == d);
            			}
            			else {
HXLINE( 287)				_hx_tmp2 = false;
            			}
HXDLIN( 287)			if (_hx_tmp2) {
HXLINE( 287)				_hx_tmp1 = (transform->tx == tx);
            			}
            			else {
HXLINE( 287)				_hx_tmp1 = false;
            			}
HXDLIN( 287)			if (_hx_tmp1) {
HXLINE( 287)				_hx_tmp = (transform->ty == ty);
            			}
            			else {
...
HXLINE( 292)			Float scaleX = ((Float)0.0);
HXLINE( 293)			Float scaleY = ((Float)0.0);
HXLINE( 295)			if ((b == 0)) {
HXLINE( 297)				scaleX = a;
            			}
            			else {
HXLINE( 301)				scaleX = ::Math_obj::sqrt(((a * a) + (b * b)));
            			}
HXLINE( 304)			if ((c == 0)) {
HXLINE( 306)				scaleY = d;
            			}
            			else {
HXLINE( 310)				scaleY = ::Math_obj::sqrt(((c * c) + (d * d)));
            			}
HXLINE( 313)			this->_hx___displayObject->_hx___scaleX = scaleX;
HXLINE( 314)			this->_hx___displayObject->_hx___scaleY = scaleY;
HXLINE( 316)			Float rotation = (((( (Float)(180) ) / ::Math_obj::PI) * ::Math_obj::atan2(d,c)) - ( (Float)(90) ));
HXLINE( 318)			if ((rotation != this->_hx___displayObject->_hx___rotation)) {
HXLINE( 320)				this->_hx___displayObject->_hx___rotation = rotation;
HXLINE( 321)				Float radians = (rotation * (::Math_obj::PI / ( (Float)(180) )));
HXLINE( 322)				this->_hx___displayObject->_hx___rotationSine = ::Math_obj::sin(radians);
HXLINE( 323)				this->_hx___displayObject->_hx___rotationCosine = ::Math_obj::cos(radians);
            			}
HXLINE( 326)			transform->a = a;
HXLINE( 327)			transform->b = b;
HXLINE( 328)			transform->c = c;
HXLINE( 329)			transform->d = d;
HXLINE( 330)			transform->tx = tx;
HXLINE( 331)			transform->ty = ty;
HXLINE( 333)			this->_hx___displayObject->_hx___setTransformDirty();
            		}
            	}
