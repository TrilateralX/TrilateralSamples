...
HX_LOCAL_STACK_FRAME(_hx_pos_93e061bb8319ab07_18_clear,"org.poly2tri.Basin","clear",0x310f9759,"org.poly2tri.Basin.clear","org/poly2tri/Basin.hx",18,0xb13935a4)
namespace org{
namespace poly2tri{
...
void Basin_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_93e061bb8319ab07_18_clear)
HXLINE(  20)		this->left_node = null();
HXLINE(  21)		this->bottom_node = null();
HXLINE(  22)		this->right_node = null();
HXLINE(  23)		this->width = ((Float)0.0);
HXLINE(  24)		this->left_highest = false;
            	}
...
::hx::ObjectPtr< Basin_obj > Basin_obj::__alloc(::hx::Ctx *_hx_ctx) {
