...
trilateral3_nodule_PenNodule.prototype = {
	createPen: function() {
		...
		var color3Abstract = { set_argb : function(col) {
			...
			return Math.round(_e31[(_e31[0] | 0) * 21 + 13 + 2] * 255) << 24 | Math.round(dsHelper_flatInterleave_FloatColorTriangles.get_redB(_e31) * 255) << 16 | Math.round(_e31[(_e31[0] | 0) * 21 + 11 + 2] * 255) << 8 | Math.round(_e31[(_e31[0] | 0) * 21 + 12 + 2] * 255);
			...
			return Math.round(_e33[(_e33[0] | 0) * 21 + 20 + 2] * 255) << 24 | Math.round(dsHelper_flatInterleave_FloatColorTriangles.get_redC(_e33) * 255) << 16 | Math.round(_e33[(_e33[0] | 0) * 21 + 18 + 2] * 255) << 8 | Math.round(_e33[(_e33[0] | 0) * 21 + 19 + 2] * 255);
		}};
		var _e34 = t;
		var _e35 = t;
		var _e36 = t;
		...
		var colorAbstract = { cornerColors : function(colorA,colorB,colorC) {
			...
			return new trilateral3_structure_TriInt(Math.round(_e36[(_e36[0] | 0) * 21 + 6 + 2] * 255) << 24 | Math.round(dsHelper_flatInterleave_FloatColorTriangles.get_redA(_e36) * 255) << 16 | Math.round(_e36[(_e36[0] | 0) * 21 + 4 + 2] * 255) << 8 | Math.round(_e36[(_e36[0] | 0) * 21 + 5 + 2] * 255),Math.round(_e36[(_e36[0] | 0) * 21 + 13 + 2] * 255) << 24 | Math.round(dsHelper_flatInterleave_FloatColorTriangles.get_redB(_e36) * 255) << 16 | Math.round(_e36[(_e36[0] | 0) * 21 + 11 + 2] * 255) << 8 | Math.round(_e36[(_e36[0] | 0) * 21 + 12 + 2] * 255),Math.round(_e36[(_e36[0] | 0) * 21 + 20 + 2] * 255) << 24 | Math.round(dsHelper_flatInterleave_FloatColorTriangles.get_redC(_e36) * 255) << 16 | Math.round(_e36[(_e36[0] | 0) * 21 + 18 + 2] * 255) << 8 | Math.round(_e36[(_e36[0] | 0) * 21 + 19 + 2] * 255));
		}, get_pos : function() {
			return _e37[0];
		}, set_pos : function(pos_) {
			_e38[0] = pos_;
