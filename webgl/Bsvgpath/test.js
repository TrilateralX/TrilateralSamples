...
var TrilateralSVG = function(width,height,animate) {
	this.penColor = new trilateral3_nodule_PenArrColor();
...
TrilateralSVG.__name__ = true;
TrilateralSVG.__super__ = kitGL_glWeb_Ply;
TrilateralSVG.prototype = $extend(kitGL_glWeb_Ply.prototype,{
	draw: function() {
		haxe_Log.trace("draw",{ fileName : "TrilateralSVG.hx", lineNumber : 41, className : "TrilateralSVG", methodName : "draw"});
...
function TrilateralSVG_main() {
	var divertTrace = new kitGL_glWeb_DivertTrace();
	haxe_Log.trace("TrilateralSVG example",{ fileName : "TrilateralSVG.hx", lineNumber : 25, className : "_TrilateralSVG.TrilateralSVG_Fields_", methodName : "main"});
