...
TrilateralFill.__super__ = kitGL_glWeb_InterleaveAlterGL;
TrilateralFill.prototype = $extend(kitGL_glWeb_InterleaveAlterGL.prototype,{
	draw: function() {
...
function TrilateralFill_main() {
	...
	haxe_Log.trace("TrilateralFill example",{ fileName : "TrilateralFill.hx", lineNumber : 27, className : "_TrilateralFill.TrilateralFill_Fields_", methodName : "main"});
}
