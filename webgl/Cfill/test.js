...
var TrilateralFill = function(width,height) {
...
TrilateralFill.__name__ = true;
TrilateralFill.__super__ = kitGL_glWeb_Ply;
TrilateralFill.prototype = $extend(kitGL_glWeb_Ply.prototype,{
	draw: function() {
...
function TrilateralFill_main() {
	var divertTrace = new kitGL_glWeb_DivertTrace();
	haxe_Log.trace("TrilateralFill example",{ fileName : "TrilateralFill.hx", lineNumber : 26, className : "_TrilateralFill.TrilateralFill_Fields_", methodName : "main"});
