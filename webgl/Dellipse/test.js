...
TrilateralEllipse.__super__ = kitGL_glWeb_Ply;
TrilateralEllipse.prototype = $extend(kitGL_glWeb_Ply.prototype,{
	draw: function() {
		...
		while(_g < _g1) {
			var i = _g++;
			this.drawSet(this.pen,arcs.shift(),pallet,2 * x0,2 * yPos[i],1);
			this.drawSet(this.pen,arcs.shift(),pallet,2 * x1,2 * yPos[i],1);
		}
...
function TrilateralEllipse_main() {
	...
	haxe_Log.trace("TrilateralEllipse example",{ fileName : "TrilateralEllipse.hx", lineNumber : 26, className : "_TrilateralEllipse.TrilateralEllipse_Fields_", methodName : "main"});
