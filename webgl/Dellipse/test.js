...
TrilateralEllipse.__super__ = kitGL_glWeb_InterleaveAlterGL;
TrilateralEllipse.prototype = $extend(kitGL_glWeb_InterleaveAlterGL.prototype,{
	draw: function() {
...
function TrilateralEllipse_main() {
	...
	haxe_Log.trace("TrilateralEllipse example",{ fileName : "TrilateralEllipse.hx", lineNumber : 28, className : "_TrilateralEllipse.TrilateralEllipse_Fields_", methodName : "main"});
}
...
justPath_SvgPath.prototype = {
	parse: function(str_) {
		...
		while(this.pos < this.l) {
			haxe_Log.trace("pos" + this.pos + " " + this.l,{ fileName : "justPath/SvgPath.hx", lineNumber : 35, className : "justPath.SvgPath", methodName : "parse"});
			switch(this.c) {
			case 65:
				...
				break;
			case 66:
				haxe_Log.trace(this.pos + " " + count + "  " + Std.string(this.store),{ fileName : "justPath/SvgPath.hx", lineNumber : 378, className : "justPath.SvgPath", methodName : "parse"});
				haxe_Log.trace("bearing - not implemented",{ fileName : "justPath/SvgPath.hx", lineNumber : 379, className : "justPath.SvgPath", methodName : "parse"});
