...
function TrilateralRegularColor_main() {
	...
	haxe_Log.trace("TrilateralRegularColor example",{ fileName : "TrilateralRegularColor.hx", lineNumber : 39, className : "_TrilateralRegularColor.TrilateralRegularColor_Fields_", methodName : "main"});
}
