...
var TrilateralTextureBasic = function(width,height) {
	...
	haxe_Log.trace("draw",{ fileName : "TrilateralTileSheetTexture.hx", lineNumber : 72, className : "TrilateralTextureBasic", methodName : "new"});
...
TrilateralTextureBasic.prototype = $extend(kitGL_glWeb_PlyMix.prototype,{
	...
	,renderDraw: function() {
		haxe_Log.trace("renderDraw",{ fileName : "TrilateralTileSheetTexture.hx", lineNumber : 138, className : "TrilateralTextureBasic", methodName : "renderDraw"});
		var curr = this.penTexture.paintType.triangleCurrent;
		var val = 0.;
