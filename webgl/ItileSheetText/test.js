...
var TrilateralTextureBasic = function(width,height) {
	...
	haxe_Log.trace("draw",{ fileName : "TrilateralTileSheetTexture.hx", lineNumber : 65, className : "TrilateralTextureBasic", methodName : "new"});
...
TrilateralTextureBasic.prototype = $extend(kitGL_glWeb_PlyUV.prototype,{
	draw: function() {
		...
		sketch.width = 8;
		this.pen.z2D = -0.1;
		var posMin = this.pen.paintType.get_pos();
		...
		var ii_min = posMin;
		var ii_max = (this.pen.paintType.get_pos() | 0) - 1;
		var this1 = new trilateral3_shape_IntIterStart(ii_min,ii_max);
		this.allRange = this1;
		this.nymphLetters = trilateral3_drawing_Nymph.iterNymph(this.pen,this.allRange);
		var count = 0;
		var val;
		var curr = this.pen.paintType.triangleCurrent;
		var letterSpace = 40 / this.scale;
		var _g = this.allRange;
		while(_g.min < _g.max) {
			var i = _g.min++;
	...
	,renderDraw: function() {
		...
		this.drawShape(this.allRange.start,this.allRange.max,0);
	}
});
...
var trilateral3_shape_IntIterStart = function(min,max) {
	this.start = min;
	if(max == null) {
		max = min;
	}
	IntIterator.call(this,min,max);
};
trilateral3_shape_IntIterStart.__name__ = true;
trilateral3_shape_IntIterStart.__super__ = IntIterator;
trilateral3_shape_IntIterStart.prototype = $extend(IntIterator.prototype,{
});
