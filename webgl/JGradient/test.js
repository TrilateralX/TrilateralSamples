...
var kitGL_glWeb_Ply = function(width_,height_) {
	...
	this.width = width_;
	this.height = height_;
	haxe_Log.trace("creategl",{ fileName : "kitGL/glWeb/Ply.js.hx", lineNumber : 46, className : "kitGL.glWeb.Ply", methodName : "creategl"});
	var mainSheet = new kitGL_glWeb_Sheet();
	mainSheet.create(this.width,this.height,true);
	this.gl = mainSheet.gl;
	haxe_Log.trace("setup",{ fileName : "kitGL/glWeb/Ply.js.hx", lineNumber : 53, className : "kitGL.glWeb.Ply", methodName : "setup"});
	var gl = this.gl;
...
kitGL_glWeb_Ply.prototype = {
	...
	,drawShape: function(start,end) {
		haxe_Log.trace("drawShape",{ fileName : "kitGL/glWeb/Ply.js.hx", lineNumber : 83, className : "kitGL.glWeb.Ply", methodName : "drawShape"});
		var program = this.programColor;
		var dataGL = this.dataGLcolor;
		haxe_Log.trace("drawData",{ fileName : "kitGL/glWeb/Ply.js.hx", lineNumber : 88, className : "kitGL.glWeb.Ply", methodName : "drawData"});
		var partData = dataGL.get_data().subarray(start * 21,end * 21);
