...
var kitGL_glWeb_PlyMix = function(width_,height_,hasImage) {
	if(hasImage == null) {
		hasImage = true;
	}
	this.mode = 0;
	...
	if(hasImage) {
		...
		haxe_Log.trace(" setup ",{ fileName : "kitGL/glWeb/PlyMix.js.hx", lineNumber : 109, className : "kitGL.glWeb.PlyMix", methodName : "setup"});
		var gl = this.gl;
...
kitGL_glWeb_PlyMix.prototype = {
	...
	,draw: function() {
		haxe_Log.trace("parent draw",{ fileName : "kitGL/glWeb/PlyMix.js.hx", lineNumber : 154, className : "kitGL.glWeb.PlyMix", methodName : "draw"});
	}
