...
var kitGL_glWeb_PlyMix = function(width_,height_,hasImage,animate) {
	if(animate == null) {
		animate = true;
	}
	if(hasImage == null) {
...
kitGL_glWeb_PlyMix.prototype = {
	...
	,draw: function() {
		haxe_Log.trace("parent draw",{ fileName : "kitGL/glWeb/PlyMix.js.hx", lineNumber : 158, className : "kitGL.glWeb.PlyMix", methodName : "draw"});
	}
...
var TrilateralMix = function(width,height) {
	...
	haxe_Log.trace("draw",{ fileName : "TrilateralMix.hx", lineNumber : 45, className : "TrilateralMix", methodName : "new"});
...
TrilateralMix.prototype = $extend(kitGL_glWeb_PlyMix.prototype,{
	draw: function() {
		haxe_Log.trace("draw ",{ fileName : "TrilateralMix.hx", lineNumber : 72, className : "TrilateralMix", methodName : "draw"});
	...
	,renderDraw: function() {
		...
		haxe_Log.trace("penColor.size " + this.penColor.paintType.get_size(),{ fileName : "TrilateralMix.hx", lineNumber : 102, className : "TrilateralMix", methodName : "renderDraw"});
		var _this = this.penColor;
		...
		var _this = this.starOutlineShaper;
		var xy = new trilateral3_structure_XY(dx,0.);
		_this.lastXY = new trilateral3_structure_XY(_this.px,_this.py);
...
function TrilateralMix_main() {
	...
	haxe_Log.trace("TrilateralMix example",{ fileName : "TrilateralMix.hx", lineNumber : 26, className : "_TrilateralMix.TrilateralMix_Fields_", methodName : "main"});
}
var dsHelper_flat_io_ArrayFlatDepth = {};
dsHelper_flat_io_ArrayFlatDepth.rangeToEnd = function(this1,starting,totalLen,section) {
...
var dsHelper_flatInterleave_ArrayColorTriangles = {};
dsHelper_flatInterleave_ArrayColorTriangles.get_ax = function(this1) {
	return this1[(this1[0] | 0) * 21 + 1];
};
dsHelper_flatInterleave_ArrayColorTriangles.set_ax = function(this1,v) {
	this1[(this1[0] | 0) * 21 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTriangles.get_ay = function(this1) {
	return this1[(this1[0] | 0) * 21 + 1 + 1];
};
dsHelper_flatInterleave_ArrayColorTriangles.set_ay = function(this1,v) {
	this1[(this1[0] | 0) * 21 + 1 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTriangles.get_az = function(this1) {
	return this1[(this1[0] | 0) * 21 + 2 + 1];
};
dsHelper_flatInterleave_ArrayColorTriangles.set_az = function(this1,v) {
	this1[(this1[0] | 0) * 21 + 2 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTriangles.get_redA = function(this1) {
	return this1[(this1[0] | 0) * 21 + 3 + 1];
};
dsHelper_flatInterleave_ArrayColorTriangles.set_redA = function(this1,v) {
	this1[(this1[0] | 0) * 21 + 3 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTriangles.get_bx = function(this1) {
	return this1[(this1[0] | 0) * 21 + 7 + 1];
};
dsHelper_flatInterleave_ArrayColorTriangles.set_bx = function(this1,v) {
	this1[(this1[0] | 0) * 21 + 7 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTriangles.get_by = function(this1) {
	return this1[(this1[0] | 0) * 21 + 8 + 1];
};
dsHelper_flatInterleave_ArrayColorTriangles.set_by = function(this1,v) {
	this1[(this1[0] | 0) * 21 + 8 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTriangles.get_bz = function(this1) {
	return this1[(this1[0] | 0) * 21 + 9 + 1];
};
dsHelper_flatInterleave_ArrayColorTriangles.set_bz = function(this1,v) {
	this1[(this1[0] | 0) * 21 + 9 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTriangles.get_redB = function(this1) {
	return this1[(this1[0] | 0) * 21 + 10 + 1];
};
dsHelper_flatInterleave_ArrayColorTriangles.set_redB = function(this1,v) {
	this1[(this1[0] | 0) * 21 + 10 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTriangles.get_cx = function(this1) {
	return this1[(this1[0] | 0) * 21 + 14 + 1];
};
dsHelper_flatInterleave_ArrayColorTriangles.set_cx = function(this1,v) {
	this1[(this1[0] | 0) * 21 + 14 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTriangles.get_cy = function(this1) {
	return this1[(this1[0] | 0) * 21 + 15 + 1];
};
dsHelper_flatInterleave_ArrayColorTriangles.set_cy = function(this1,v) {
	this1[(this1[0] | 0) * 21 + 15 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTriangles.get_cz = function(this1) {
	return this1[(this1[0] | 0) * 21 + 16 + 1];
};
dsHelper_flatInterleave_ArrayColorTriangles.set_cz = function(this1,v) {
	this1[(this1[0] | 0) * 21 + 16 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTriangles.get_redC = function(this1) {
	return this1[(this1[0] | 0) * 21 + 17 + 1];
};
dsHelper_flatInterleave_ArrayColorTriangles.set_redC = function(this1,v) {
	this1[(this1[0] | 0) * 21 + 17 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTriangles.triangle = function(this1,ax_,ay_,az_,bx_,by_,bz_,cx_,cy_,cz_) {
	dsHelper_flatInterleave_ArrayColorTriangles.set_ax(this1,ax_);
	dsHelper_flatInterleave_ArrayColorTriangles.set_ay(this1,ay_);
	dsHelper_flatInterleave_ArrayColorTriangles.set_az(this1,az_);
	dsHelper_flatInterleave_ArrayColorTriangles.set_bx(this1,bx_);
	dsHelper_flatInterleave_ArrayColorTriangles.set_by(this1,by_);
	dsHelper_flatInterleave_ArrayColorTriangles.set_bz(this1,bz_);
	dsHelper_flatInterleave_ArrayColorTriangles.set_cx(this1,cx_);
	dsHelper_flatInterleave_ArrayColorTriangles.set_cy(this1,cy_);
	dsHelper_flatInterleave_ArrayColorTriangles.set_cz(this1,cz_);
	var windingAdjusted = dsHelper_flatInterleave_ArrayColorTriangles.adjustWinding(this1);
	if(windingAdjusted) {
		dsHelper_flatInterleave_ArrayColorTriangles.set_ax(this1,ax_);
		dsHelper_flatInterleave_ArrayColorTriangles.set_ay(this1,ay_);
		dsHelper_flatInterleave_ArrayColorTriangles.set_bx(this1,cx_);
		dsHelper_flatInterleave_ArrayColorTriangles.set_by(this1,cy_);
		dsHelper_flatInterleave_ArrayColorTriangles.set_cx(this1,bx_);
		dsHelper_flatInterleave_ArrayColorTriangles.set_cy(this1,by_);
	}
	return windingAdjusted;
};
dsHelper_flatInterleave_ArrayColorTriangles.adjustWinding = function(this1) {
	return dsHelper_flatInterleave_ArrayColorTriangles.get_ax(this1) * dsHelper_flatInterleave_ArrayColorTriangles.get_by(this1) - dsHelper_flatInterleave_ArrayColorTriangles.get_bx(this1) * dsHelper_flatInterleave_ArrayColorTriangles.get_ay(this1) + (dsHelper_flatInterleave_ArrayColorTriangles.get_bx(this1) * dsHelper_flatInterleave_ArrayColorTriangles.get_cy(this1) - dsHelper_flatInterleave_ArrayColorTriangles.get_cx(this1) * dsHelper_flatInterleave_ArrayColorTriangles.get_by(this1)) + (dsHelper_flatInterleave_ArrayColorTriangles.get_cx(this1) * dsHelper_flatInterleave_ArrayColorTriangles.get_ay(this1) - dsHelper_flatInterleave_ArrayColorTriangles.get_ax(this1) * dsHelper_flatInterleave_ArrayColorTriangles.get_cy(this1)) > 0;
};
dsHelper_flatInterleave_ArrayColorTriangles.moveDelta = function(this1,dx,dy) {
	dsHelper_flatInterleave_ArrayColorTriangles.set_ax(this1,dsHelper_flatInterleave_ArrayColorTriangles.get_ax(this1) + dx);
	dsHelper_flatInterleave_ArrayColorTriangles.set_ay(this1,dsHelper_flatInterleave_ArrayColorTriangles.get_ay(this1) + dy);
	dsHelper_flatInterleave_ArrayColorTriangles.set_bx(this1,dsHelper_flatInterleave_ArrayColorTriangles.get_bx(this1) + dx);
	dsHelper_flatInterleave_ArrayColorTriangles.set_by(this1,dsHelper_flatInterleave_ArrayColorTriangles.get_by(this1) + dy);
	dsHelper_flatInterleave_ArrayColorTriangles.set_cx(this1,dsHelper_flatInterleave_ArrayColorTriangles.get_cx(this1) + dx);
	dsHelper_flatInterleave_ArrayColorTriangles.set_cy(this1,dsHelper_flatInterleave_ArrayColorTriangles.get_cy(this1) + dy);
};
dsHelper_flatInterleave_ArrayColorTriangles.fullHit = function(this1,px,py) {
	if(px > Math.min(Math.min(dsHelper_flatInterleave_ArrayColorTriangles.get_ax(this1),dsHelper_flatInterleave_ArrayColorTriangles.get_bx(this1)),dsHelper_flatInterleave_ArrayColorTriangles.get_cx(this1)) && px < Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTriangles.get_ax(this1),dsHelper_flatInterleave_ArrayColorTriangles.get_bx(this1)),dsHelper_flatInterleave_ArrayColorTriangles.get_cx(this1)) && py > Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTriangles.get_ay(this1),dsHelper_flatInterleave_ArrayColorTriangles.get_by(this1)),dsHelper_flatInterleave_ArrayColorTriangles.get_cy(this1)) && py < Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTriangles.get_ay(this1),dsHelper_flatInterleave_ArrayColorTriangles.get_by(this1)),dsHelper_flatInterleave_ArrayColorTriangles.get_cy(this1))) {
		return true;
	}
	var planeAB = (dsHelper_flatInterleave_ArrayColorTriangles.get_ax(this1) - px) * (dsHelper_flatInterleave_ArrayColorTriangles.get_by(this1) - py) - (dsHelper_flatInterleave_ArrayColorTriangles.get_bx(this1) - px) * (dsHelper_flatInterleave_ArrayColorTriangles.get_ay(this1) - py);
	var planeBC = (dsHelper_flatInterleave_ArrayColorTriangles.get_bx(this1) - px) * (dsHelper_flatInterleave_ArrayColorTriangles.get_cy(this1) - py) - (dsHelper_flatInterleave_ArrayColorTriangles.get_cx(this1) - px) * (dsHelper_flatInterleave_ArrayColorTriangles.get_by(this1) - py);
	var planeCA = (dsHelper_flatInterleave_ArrayColorTriangles.get_cx(this1) - px) * (dsHelper_flatInterleave_ArrayColorTriangles.get_ay(this1) - py) - (dsHelper_flatInterleave_ArrayColorTriangles.get_ax(this1) - px) * (dsHelper_flatInterleave_ArrayColorTriangles.get_cy(this1) - py);
...
var dsHelper_flatInterleave_ArrayColorTrianglesUV = {};
dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax = function(this1) {
	return this1[(this1[0] | 0) * 27 + 1];
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ax = function(this1,v) {
	this1[(this1[0] | 0) * 27 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay = function(this1) {
	return this1[(this1[0] | 0) * 27 + 1 + 1];
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ay = function(this1,v) {
	this1[(this1[0] | 0) * 27 + 1 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.get_az = function(this1) {
	return this1[(this1[0] | 0) * 27 + 2 + 1];
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.set_az = function(this1,v) {
	this1[(this1[0] | 0) * 27 + 2 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.get_redA = function(this1) {
	return this1[(this1[0] | 0) * 27 + 3 + 1];
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.set_redA = function(this1,v) {
	this1[(this1[0] | 0) * 27 + 3 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx = function(this1) {
	return this1[(this1[0] | 0) * 27 + 9 + 1];
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bx = function(this1,v) {
	this1[(this1[0] | 0) * 27 + 9 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by = function(this1) {
	return this1[(this1[0] | 0) * 27 + 10 + 1];
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.set_by = function(this1,v) {
	this1[(this1[0] | 0) * 27 + 10 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bz = function(this1) {
	return this1[(this1[0] | 0) * 27 + 11 + 1];
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bz = function(this1,v) {
	this1[(this1[0] | 0) * 27 + 11 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.get_redB = function(this1) {
	return this1[(this1[0] | 0) * 27 + 12 + 1];
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.set_redB = function(this1,v) {
	this1[(this1[0] | 0) * 27 + 12 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx = function(this1) {
	return this1[(this1[0] | 0) * 27 + 18 + 1];
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cx = function(this1,v) {
	this1[(this1[0] | 0) * 27 + 18 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy = function(this1) {
	return this1[(this1[0] | 0) * 27 + 19 + 1];
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cy = function(this1,v) {
	this1[(this1[0] | 0) * 27 + 19 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cz = function(this1) {
	return this1[(this1[0] | 0) * 27 + 20 + 1];
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cz = function(this1,v) {
	this1[(this1[0] | 0) * 27 + 20 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.get_redC = function(this1) {
	return this1[(this1[0] | 0) * 27 + 21 + 1];
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.set_redC = function(this1,v) {
	this1[(this1[0] | 0) * 27 + 21 + 1] = v;
	return v;
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.triangle = function(this1,ax_,ay_,az_,bx_,by_,bz_,cx_,cy_,cz_) {
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ax(this1,ax_);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ay(this1,ay_);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_az(this1,az_);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bx(this1,bx_);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_by(this1,by_);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bz(this1,bz_);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cx(this1,cx_);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cy(this1,cy_);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cz(this1,cz_);
	var windingAdjusted = dsHelper_flatInterleave_ArrayColorTrianglesUV.adjustWinding(this1);
	if(windingAdjusted) {
		dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bx(this1,cx_);
		dsHelper_flatInterleave_ArrayColorTrianglesUV.set_by(this1,cy_);
		dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cx(this1,bx_);
		dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cy(this1,by_);
	}
	return windingAdjusted;
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.triangleUV = function(this1,uA_,vA_,uB_,vB_,uC_,vC_,windAdjust_) {
	var windAdjust = windAdjust_ == null ? dsHelper_flatInterleave_ArrayColorTrianglesUV.adjustWinding(this1) : windAdjust_;
...
dsHelper_flatInterleave_ArrayColorTrianglesUV.adjustWinding = function(this1) {
	return dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(this1) * dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(this1) - dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(this1) * dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(this1) + (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(this1) * dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(this1) - dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(this1) * dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(this1)) + (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(this1) * dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(this1) - dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(this1) * dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(this1)) > 0;
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.moveDelta = function(this1,dx,dy) {
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ax(this1,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(this1) + dx);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ay(this1,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(this1) + dy);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bx(this1,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(this1) + dx);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_by(this1,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(this1) + dy);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cx(this1,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(this1) + dx);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cy(this1,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(this1) + dy);
};
dsHelper_flatInterleave_ArrayColorTrianglesUV.fullHit = function(this1,px,py) {
	if(px > Math.min(Math.min(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(this1),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(this1)),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(this1)) && px < Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(this1),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(this1)),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(this1)) && py > Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(this1),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(this1)),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(this1)) && py < Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(this1),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(this1)),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(this1))) {
		return true;
	}
	var planeAB = (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(this1) - px) * (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(this1) - py) - (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(this1) - px) * (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(this1) - py);
	var planeBC = (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(this1) - px) * (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(this1) - py) - (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(this1) - px) * (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(this1) - py);
	var planeCA = (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(this1) - px) * (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(this1) - py) - (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(this1) - px) * (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(this1) - py);
	if((Math.abs(planeAB) / planeAB | 0) == (Math.abs(planeBC) / planeBC | 0)) {
		return (Math.abs(planeBC) / planeBC | 0) == (Math.abs(planeCA) / planeCA | 0);
	} else {
		return false;
...
dsHelper_flatInterleave_ArrayColorTrianglesUV.moveDeltaUV = function(this1,du,dv) {
...
trilateral3_geom_FlatArrayTriangles.transform = function(this1,m) {
	var pa = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTriangles.get_ax(this1),dsHelper_flatInterleave_ArrayColorTriangles.get_ay(this1),dsHelper_flatInterleave_ArrayColorTriangles.get_az(this1),1.);
	var pb = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTriangles.get_bx(this1),dsHelper_flatInterleave_ArrayColorTriangles.get_by(this1),dsHelper_flatInterleave_ArrayColorTriangles.get_bz(this1),1.);
	var pc = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTriangles.get_cx(this1),dsHelper_flatInterleave_ArrayColorTriangles.get_cy(this1),dsHelper_flatInterleave_ArrayColorTriangles.get_cz(this1),1.);
	...
	pc = v2;
	dsHelper_flatInterleave_ArrayColorTriangles.set_ax(this1,pa.x);
	dsHelper_flatInterleave_ArrayColorTriangles.set_ay(this1,pa.y);
	dsHelper_flatInterleave_ArrayColorTriangles.set_az(this1,pa.z);
	dsHelper_flatInterleave_ArrayColorTriangles.set_bx(this1,pb.x);
	dsHelper_flatInterleave_ArrayColorTriangles.set_by(this1,pb.y);
	dsHelper_flatInterleave_ArrayColorTriangles.set_bz(this1,pb.z);
	dsHelper_flatInterleave_ArrayColorTriangles.set_cx(this1,pc.x);
	dsHelper_flatInterleave_ArrayColorTriangles.set_cy(this1,pc.y);
	dsHelper_flatInterleave_ArrayColorTriangles.set_cz(this1,pc.z);
};
...
trilateral3_geom_FlatArrayTrianglesUV.transform = function(this1,m) {
	var pa = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(this1),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(this1),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_az(this1),1.);
	var pb = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(this1),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(this1),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bz(this1),1.);
	var pc = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(this1),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(this1),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cz(this1),1.);
	var v2 = new trilateral3_matrix_Vertex(m.a * pa.x + m.b * pa.y + m.c * pa.z + m.d,m.e * pa.x + m.f * pa.y + m.g * pa.z + m.h,m.i * pa.x + m.j * pa.y + m.k * pa.z + m.l,1.);
	pa = v2;
	var v2 = new trilateral3_matrix_Vertex(m.a * pb.x + m.b * pb.y + m.c * pb.z + m.d,m.e * pb.x + m.f * pb.y + m.g * pb.z + m.h,m.i * pb.x + m.j * pb.y + m.k * pb.z + m.l,1.);
	pb = v2;
	var v2 = new trilateral3_matrix_Vertex(m.a * pc.x + m.b * pc.y + m.c * pc.z + m.d,m.e * pc.x + m.f * pc.y + m.g * pc.z + m.h,m.i * pc.x + m.j * pc.y + m.k * pc.z + m.l,1.);
	pc = v2;
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ax(this1,pa.x);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ay(this1,pa.y);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_az(this1,pa.z);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bx(this1,pb.x);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_by(this1,pb.y);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bz(this1,pb.z);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cx(this1,pc.x);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cy(this1,pc.y);
	dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cz(this1,pc.z);
};
...
trilateral3_nodule_PenArrColor.prototype = $extend(trilateral3_nodule_PenNodule.prototype,{
	createPen: function() {
		...
		var triangleAbstract = { rotate : function(x,y,theta) {
			var cos = Math.cos(-theta);
			var sin = Math.sin(-theta);
			dsHelper_flatInterleave_ArrayColorTriangles.set_ax(_e,dsHelper_flatInterleave_ArrayColorTriangles.get_ax(_e) - x);
			dsHelper_flatInterleave_ArrayColorTriangles.set_ay(_e,dsHelper_flatInterleave_ArrayColorTriangles.get_ay(_e) - y);
			dsHelper_flatInterleave_ArrayColorTriangles.set_bx(_e,dsHelper_flatInterleave_ArrayColorTriangles.get_bx(_e) - x);
			dsHelper_flatInterleave_ArrayColorTriangles.set_by(_e,dsHelper_flatInterleave_ArrayColorTriangles.get_by(_e) - y);
			dsHelper_flatInterleave_ArrayColorTriangles.set_cx(_e,dsHelper_flatInterleave_ArrayColorTriangles.get_cx(_e) - x);
			dsHelper_flatInterleave_ArrayColorTriangles.set_cy(_e,dsHelper_flatInterleave_ArrayColorTriangles.get_cy(_e) - y);
			var dx = dsHelper_flatInterleave_ArrayColorTriangles.get_ax(_e);
			var dy = dsHelper_flatInterleave_ArrayColorTriangles.get_ay(_e);
			dsHelper_flatInterleave_ArrayColorTriangles.set_ax(_e,dx * cos - dy * sin);
			dsHelper_flatInterleave_ArrayColorTriangles.set_ay(_e,dx * sin + dy * cos);
			dx = dsHelper_flatInterleave_ArrayColorTriangles.get_bx(_e);
			dy = dsHelper_flatInterleave_ArrayColorTriangles.get_by(_e);
			dsHelper_flatInterleave_ArrayColorTriangles.set_bx(_e,dx * cos - dy * sin);
			dsHelper_flatInterleave_ArrayColorTriangles.set_by(_e,dx * sin + dy * cos);
			dx = dsHelper_flatInterleave_ArrayColorTriangles.get_cx(_e);
			dy = dsHelper_flatInterleave_ArrayColorTriangles.get_cy(_e);
			dsHelper_flatInterleave_ArrayColorTriangles.set_cx(_e,dx * cos - dy * sin);
			dsHelper_flatInterleave_ArrayColorTriangles.set_cy(_e,dx * sin + dy * cos);
			dsHelper_flatInterleave_ArrayColorTriangles.set_ax(_e,dsHelper_flatInterleave_ArrayColorTriangles.get_ax(_e) + x);
			dsHelper_flatInterleave_ArrayColorTriangles.set_ay(_e,dsHelper_flatInterleave_ArrayColorTriangles.get_ay(_e) + y);
			dsHelper_flatInterleave_ArrayColorTriangles.set_bx(_e,dsHelper_flatInterleave_ArrayColorTriangles.get_bx(_e) + x);
			dsHelper_flatInterleave_ArrayColorTriangles.set_by(_e,dsHelper_flatInterleave_ArrayColorTriangles.get_by(_e) + y);
			...
			dsHelper_flatInterleave_ArrayColorTriangles.moveDelta(_e1,dx,dy);
		}, rotateTrig : function(x,y,cos,sin) {
			dsHelper_flatInterleave_ArrayColorTriangles.set_ax(_e2,dsHelper_flatInterleave_ArrayColorTriangles.get_ax(_e2) - x);
			dsHelper_flatInterleave_ArrayColorTriangles.set_ay(_e2,dsHelper_flatInterleave_ArrayColorTriangles.get_ay(_e2) - y);
			dsHelper_flatInterleave_ArrayColorTriangles.set_bx(_e2,dsHelper_flatInterleave_ArrayColorTriangles.get_bx(_e2) - x);
			dsHelper_flatInterleave_ArrayColorTriangles.set_by(_e2,dsHelper_flatInterleave_ArrayColorTriangles.get_by(_e2) - y);
			dsHelper_flatInterleave_ArrayColorTriangles.set_cx(_e2,dsHelper_flatInterleave_ArrayColorTriangles.get_cx(_e2) - x);
			dsHelper_flatInterleave_ArrayColorTriangles.set_cy(_e2,dsHelper_flatInterleave_ArrayColorTriangles.get_cy(_e2) - y);
			var dx = dsHelper_flatInterleave_ArrayColorTriangles.get_ax(_e2);
			var dy = dsHelper_flatInterleave_ArrayColorTriangles.get_ay(_e2);
			dsHelper_flatInterleave_ArrayColorTriangles.set_ax(_e2,dx * cos - dy * sin);
			dsHelper_flatInterleave_ArrayColorTriangles.set_ay(_e2,dx * sin + dy * cos);
			dx = dsHelper_flatInterleave_ArrayColorTriangles.get_bx(_e2);
			dy = dsHelper_flatInterleave_ArrayColorTriangles.get_by(_e2);
			dsHelper_flatInterleave_ArrayColorTriangles.set_bx(_e2,dx * cos - dy * sin);
			dsHelper_flatInterleave_ArrayColorTriangles.set_by(_e2,dx * sin + dy * cos);
			dx = dsHelper_flatInterleave_ArrayColorTriangles.get_cx(_e2);
			dy = dsHelper_flatInterleave_ArrayColorTriangles.get_cy(_e2);
			dsHelper_flatInterleave_ArrayColorTriangles.set_cx(_e2,dx * cos - dy * sin);
			dsHelper_flatInterleave_ArrayColorTriangles.set_cy(_e2,dx * sin + dy * cos);
			dsHelper_flatInterleave_ArrayColorTriangles.set_ax(_e2,dsHelper_flatInterleave_ArrayColorTriangles.get_ax(_e2) + x);
			dsHelper_flatInterleave_ArrayColorTriangles.set_ay(_e2,dsHelper_flatInterleave_ArrayColorTriangles.get_ay(_e2) + y);
			dsHelper_flatInterleave_ArrayColorTriangles.set_bx(_e2,dsHelper_flatInterleave_ArrayColorTriangles.get_bx(_e2) + x);
			dsHelper_flatInterleave_ArrayColorTriangles.set_by(_e2,dsHelper_flatInterleave_ArrayColorTriangles.get_by(_e2) + y);
			...
			return dsHelper_flatInterleave_ArrayColorTriangles.fullHit(_e3,px,py);
		}, liteHit : function(px,py) {
			var planeAB = (dsHelper_flatInterleave_ArrayColorTriangles.get_ax(_e4) - px) * (dsHelper_flatInterleave_ArrayColorTriangles.get_by(_e4) - py) - (dsHelper_flatInterleave_ArrayColorTriangles.get_bx(_e4) - px) * (dsHelper_flatInterleave_ArrayColorTriangles.get_ay(_e4) - py);
			var planeBC = (dsHelper_flatInterleave_ArrayColorTriangles.get_bx(_e4) - px) * (dsHelper_flatInterleave_ArrayColorTriangles.get_cy(_e4) - py) - (dsHelper_flatInterleave_ArrayColorTriangles.get_cx(_e4) - px) * (dsHelper_flatInterleave_ArrayColorTriangles.get_by(_e4) - py);
			var planeCA = (dsHelper_flatInterleave_ArrayColorTriangles.get_cx(_e4) - px) * (dsHelper_flatInterleave_ArrayColorTriangles.get_ay(_e4) - py) - (dsHelper_flatInterleave_ArrayColorTriangles.get_ax(_e4) - px) * (dsHelper_flatInterleave_ArrayColorTriangles.get_cy(_e4) - py);
			if((Math.abs(planeAB) / planeAB | 0) == (Math.abs(planeBC) / planeBC | 0)) {
				return (Math.abs(planeBC) / planeBC | 0) == (Math.abs(planeCA) / planeCA | 0);
			} else {
				return false;
			...
			return Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTriangles.get_ay(_e5),dsHelper_flatInterleave_ArrayColorTriangles.get_by(_e5)),dsHelper_flatInterleave_ArrayColorTriangles.get_cy(_e5));
		}, get_back : function() {
			return Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTriangles.get_az(_e6),dsHelper_flatInterleave_ArrayColorTriangles.get_bz(_e6)),dsHelper_flatInterleave_ArrayColorTriangles.get_cz(_e6));
		}, get_right : function() {
			return Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTriangles.get_ax(_e7),dsHelper_flatInterleave_ArrayColorTriangles.get_bx(_e7)),dsHelper_flatInterleave_ArrayColorTriangles.get_cx(_e7));
		}, get_x : function() {
			return Math.min(Math.min(dsHelper_flatInterleave_ArrayColorTriangles.get_ax(_e8),dsHelper_flatInterleave_ArrayColorTriangles.get_bx(_e8)),dsHelper_flatInterleave_ArrayColorTriangles.get_cx(_e8));
		}, set_x : function(x) {
			var dx = x - Math.min(Math.min(dsHelper_flatInterleave_ArrayColorTriangles.get_ax(_e9),dsHelper_flatInterleave_ArrayColorTriangles.get_bx(_e9)),dsHelper_flatInterleave_ArrayColorTriangles.get_cx(_e9));
			dsHelper_flatInterleave_ArrayColorTriangles.set_ax(_e9,dsHelper_flatInterleave_ArrayColorTriangles.get_ax(_e9) + dx);
			dsHelper_flatInterleave_ArrayColorTriangles.set_bx(_e9,dsHelper_flatInterleave_ArrayColorTriangles.get_bx(_e9) + dx);
			dsHelper_flatInterleave_ArrayColorTriangles.set_cx(_e9,dsHelper_flatInterleave_ArrayColorTriangles.get_cx(_e9) + dx);
			return x;
		}, get_y : function() {
			return Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTriangles.get_ay(_e10),dsHelper_flatInterleave_ArrayColorTriangles.get_by(_e10)),dsHelper_flatInterleave_ArrayColorTriangles.get_cy(_e10));
		}, set_y : function(y) {
			var dy = y - Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTriangles.get_ay(_e11),dsHelper_flatInterleave_ArrayColorTriangles.get_by(_e11)),dsHelper_flatInterleave_ArrayColorTriangles.get_cy(_e11));
			dsHelper_flatInterleave_ArrayColorTriangles.set_ay(_e11,dsHelper_flatInterleave_ArrayColorTriangles.get_ay(_e11) + dy);
			dsHelper_flatInterleave_ArrayColorTriangles.set_by(_e11,dsHelper_flatInterleave_ArrayColorTriangles.get_by(_e11) + dy);
			dsHelper_flatInterleave_ArrayColorTriangles.set_cy(_e11,dsHelper_flatInterleave_ArrayColorTriangles.get_cy(_e11) + dy);
			return y;
		}, get_z : function() {
			return Math.min(Math.min(dsHelper_flatInterleave_ArrayColorTriangles.get_az(_e12),dsHelper_flatInterleave_ArrayColorTriangles.get_bz(_e12)),dsHelper_flatInterleave_ArrayColorTriangles.get_cz(_e12));
		}, set_z : function(z) {
			var dz = z - Math.min(Math.min(dsHelper_flatInterleave_ArrayColorTriangles.get_az(_e13),dsHelper_flatInterleave_ArrayColorTriangles.get_bz(_e13)),dsHelper_flatInterleave_ArrayColorTriangles.get_cz(_e13));
			dsHelper_flatInterleave_ArrayColorTriangles.set_az(_e13,dsHelper_flatInterleave_ArrayColorTriangles.get_az(_e13) + dz);
			dsHelper_flatInterleave_ArrayColorTriangles.set_bz(_e13,dsHelper_flatInterleave_ArrayColorTriangles.get_bz(_e13) + dz);
			dsHelper_flatInterleave_ArrayColorTriangles.set_cz(_e13,dsHelper_flatInterleave_ArrayColorTriangles.get_cz(_e13) + dz);
			return z;
		}, triangle : function(ax_,ay_,az_,bx_,by_,bz_,cx_,cy_,cz_) {
			return dsHelper_flatInterleave_ArrayColorTriangles.triangle(_e14,ax_,ay_,az_,bx_,by_,bz_,cx_,cy_,cz_);
		}, getTriangle3D : function() {
			var pa = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTriangles.get_ax(_e15),dsHelper_flatInterleave_ArrayColorTriangles.get_ay(_e15),dsHelper_flatInterleave_ArrayColorTriangles.get_az(_e15),1.);
			var pb = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTriangles.get_bx(_e15),dsHelper_flatInterleave_ArrayColorTriangles.get_by(_e15),dsHelper_flatInterleave_ArrayColorTriangles.get_bz(_e15),1.);
			var pc = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTriangles.get_cx(_e15),dsHelper_flatInterleave_ArrayColorTriangles.get_cy(_e15),dsHelper_flatInterleave_ArrayColorTriangles.get_cz(_e15),1.);
		...
		var color3Abstract = { set_argb : function(col) {
			dsHelper_flatInterleave_ArrayColorTriangles.set_redA(_e17,(col >> 16 & 255) / 255);
			var v = (col & 255) / 255;
			...
			dsHelper_flatInterleave_ArrayColorTriangles.set_redB(_e17,(col >> 16 & 255) / 255);
			var v = (col & 255) / 255;
			...
			dsHelper_flatInterleave_ArrayColorTriangles.set_redC(_e17,(col >> 16 & 255) / 255);
			var v = (col & 255) / 255;
			...
			dsHelper_flatInterleave_ArrayColorTriangles.set_redA(_e18,(col >> 16 & 255) / 255);
			var v = (col & 255) / 255;
			...
			return Math.round(_e19[(_e19[0] | 0) * 21 + 6 + 1] * 255) << 24 | Math.round(dsHelper_flatInterleave_ArrayColorTriangles.get_redA(_e19) * 255) << 16 | Math.round(_e19[(_e19[0] | 0) * 21 + 4 + 1] * 255) << 8 | Math.round(_e19[(_e19[0] | 0) * 21 + 5 + 1] * 255);
		}, set_argbB : function(col) {
			dsHelper_flatInterleave_ArrayColorTriangles.set_redB(_e20,(col >> 16 & 255) / 255);
			var v = (col & 255) / 255;
			...
			return Math.round(_e21[(_e21[0] | 0) * 21 + 13 + 1] * 255) << 24 | Math.round(dsHelper_flatInterleave_ArrayColorTriangles.get_redB(_e21) * 255) << 16 | Math.round(_e21[(_e21[0] | 0) * 21 + 11 + 1] * 255) << 8 | Math.round(_e21[(_e21[0] | 0) * 21 + 12 + 1] * 255);
		}, set_argbC : function(col) {
			dsHelper_flatInterleave_ArrayColorTriangles.set_redC(_e22,(col >> 16 & 255) / 255);
			var v = (col & 255) / 255;
			...
			return Math.round(_e23[(_e23[0] | 0) * 21 + 20 + 1] * 255) << 24 | Math.round(dsHelper_flatInterleave_ArrayColorTriangles.get_redC(_e23) * 255) << 16 | Math.round(_e23[(_e23[0] | 0) * 21 + 18 + 1] * 255) << 8 | Math.round(_e23[(_e23[0] | 0) * 21 + 19 + 1] * 255);
		}};
		var _e24 = t;
		var _e25 = t;
		var _e26 = t;
		...
		var paintAbstract = { triangle : function(ax_,ay_,az_,bx_,by_,bz_,cx_,cy_,cz_) {
			return dsHelper_flatInterleave_ArrayColorTriangles.triangle(_e24,ax_,ay_,az_,bx_,by_,bz_,cx_,cy_,cz_);
		}, cornerColors : function(colorA,colorB,colorC) {
			dsHelper_flatInterleave_ArrayColorTriangles.set_redA(_e25,(colorA >> 16 & 255) / 255);
			...
			dsHelper_flatInterleave_ArrayColorTriangles.set_redB(_e25,(colorB >> 16 & 255) / 255);
			...
			dsHelper_flatInterleave_ArrayColorTriangles.set_redC(_e25,(colorC >> 16 & 255) / 255);
			...
			while(_g < _g1) {
				var i = _g++;
				dsHelper_flatInterleave_ArrayColorTriangles.set_redA(_e26,(color >> 16 & 255) / 255);
				var v = (color & 255) / 255;
				...
				dsHelper_flatInterleave_ArrayColorTriangles.set_redB(_e26,(color >> 16 & 255) / 255);
				...
				dsHelper_flatInterleave_ArrayColorTriangles.set_redC(_e26,(color >> 16 & 255) / 255);
			...
			return new trilateral3_structure_TriInt(Math.round(_e27[(_e27[0] | 0) * 21 + 6 + 1] * 255) << 24 | Math.round(dsHelper_flatInterleave_ArrayColorTriangles.get_redA(_e27) * 255) << 16 | Math.round(_e27[(_e27[0] | 0) * 21 + 4 + 1] * 255) << 8 | Math.round(_e27[(_e27[0] | 0) * 21 + 5 + 1] * 255),Math.round(_e27[(_e27[0] | 0) * 21 + 13 + 1] * 255) << 24 | Math.round(dsHelper_flatInterleave_ArrayColorTriangles.get_redB(_e27) * 255) << 16 | Math.round(_e27[(_e27[0] | 0) * 21 + 11 + 1] * 255) << 8 | Math.round(_e27[(_e27[0] | 0) * 21 + 12 + 1] * 255),Math.round(_e27[(_e27[0] | 0) * 21 + 20 + 1] * 255) << 24 | Math.round(dsHelper_flatInterleave_ArrayColorTriangles.get_redC(_e27) * 255) << 16 | Math.round(_e27[(_e27[0] | 0) * 21 + 18 + 1] * 255) << 8 | Math.round(_e27[(_e27[0] | 0) * 21 + 19 + 1] * 255));
		}, transform : function(m) {
			...
			var pa = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTriangles.get_ax(_e30),dsHelper_flatInterleave_ArrayColorTriangles.get_ay(_e30),dsHelper_flatInterleave_ArrayColorTriangles.get_az(_e30),1.);
			var pb = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTriangles.get_bx(_e30),dsHelper_flatInterleave_ArrayColorTriangles.get_by(_e30),dsHelper_flatInterleave_ArrayColorTriangles.get_bz(_e30),1.);
			var pc = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTriangles.get_cx(_e30),dsHelper_flatInterleave_ArrayColorTriangles.get_cy(_e30),dsHelper_flatInterleave_ArrayColorTriangles.get_cz(_e30),1.);
			return new trilateral3_structure_Triangle3D(pa,pb,pc);
		}, next : function() {
			var pos_ = _e31[0] + 1.;
			_e31[0] = pos_;
			...
			return dsHelper_flat_io_ArrayFlatDepth.rangeToEnd(_e37,id * 21,21 * len | 0,_e37.length - 1);
...
trilateral3_nodule_PenArrTexture.prototype = $extend(trilateral3_nodule_PenNodule.prototype,{
	createPen: function() {
		...
		var triangleAbstract = { rotate : function(x,y,theta) {
			var cos = Math.cos(-theta);
			var sin = Math.sin(-theta);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ax(_e,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(_e) - x);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ay(_e,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(_e) - y);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bx(_e,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(_e) - x);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_by(_e,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(_e) - y);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cx(_e,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(_e) - x);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cy(_e,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(_e) - y);
			var dx = dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(_e);
			var dy = dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(_e);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ax(_e,dx * cos - dy * sin);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ay(_e,dx * sin + dy * cos);
			dx = dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(_e);
			dy = dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(_e);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bx(_e,dx * cos - dy * sin);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_by(_e,dx * sin + dy * cos);
			dx = dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(_e);
			dy = dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(_e);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cx(_e,dx * cos - dy * sin);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cy(_e,dx * sin + dy * cos);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ax(_e,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(_e) + x);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ay(_e,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(_e) + y);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bx(_e,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(_e) + x);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_by(_e,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(_e) + y);
			...
			dsHelper_flatInterleave_ArrayColorTrianglesUV.moveDelta(_e1,dx,dy);
		}, rotateTrig : function(x,y,cos,sin) {
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ax(_e2,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(_e2) - x);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ay(_e2,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(_e2) - y);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bx(_e2,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(_e2) - x);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_by(_e2,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(_e2) - y);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cx(_e2,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(_e2) - x);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cy(_e2,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(_e2) - y);
			var dx = dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(_e2);
			var dy = dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(_e2);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ax(_e2,dx * cos - dy * sin);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ay(_e2,dx * sin + dy * cos);
			dx = dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(_e2);
			dy = dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(_e2);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bx(_e2,dx * cos - dy * sin);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_by(_e2,dx * sin + dy * cos);
			dx = dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(_e2);
			dy = dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(_e2);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cx(_e2,dx * cos - dy * sin);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cy(_e2,dx * sin + dy * cos);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ax(_e2,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(_e2) + x);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ay(_e2,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(_e2) + y);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bx(_e2,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(_e2) + x);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_by(_e2,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(_e2) + y);
			...
			return dsHelper_flatInterleave_ArrayColorTrianglesUV.fullHit(_e3,px,py);
		}, liteHit : function(px,py) {
			var planeAB = (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(_e4) - px) * (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(_e4) - py) - (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(_e4) - px) * (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(_e4) - py);
			var planeBC = (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(_e4) - px) * (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(_e4) - py) - (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(_e4) - px) * (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(_e4) - py);
			var planeCA = (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(_e4) - px) * (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(_e4) - py) - (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(_e4) - px) * (dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(_e4) - py);
			if((Math.abs(planeAB) / planeAB | 0) == (Math.abs(planeBC) / planeBC | 0)) {
				return (Math.abs(planeBC) / planeBC | 0) == (Math.abs(planeCA) / planeCA | 0);
			} else {
				return false;
			...
			return Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(_e5),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(_e5)),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(_e5));
		}, get_back : function() {
			return Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_az(_e6),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bz(_e6)),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cz(_e6));
		}, get_right : function() {
			return Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(_e7),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(_e7)),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(_e7));
		}, get_x : function() {
			return Math.min(Math.min(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(_e8),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(_e8)),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(_e8));
		}, set_x : function(x) {
			var dx = x - Math.min(Math.min(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(_e9),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(_e9)),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(_e9));
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ax(_e9,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(_e9) + dx);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bx(_e9,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(_e9) + dx);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cx(_e9,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(_e9) + dx);
			return x;
		}, get_y : function() {
			return Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(_e10),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(_e10)),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(_e10));
		}, set_y : function(y) {
			var dy = y - Math.max(Math.max(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(_e11),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(_e11)),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(_e11));
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_ay(_e11,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(_e11) + dy);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_by(_e11,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(_e11) + dy);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cy(_e11,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(_e11) + dy);
			return y;
		}, get_z : function() {
			return Math.min(Math.min(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_az(_e12),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bz(_e12)),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cz(_e12));
		}, set_z : function(z) {
			var dz = z - Math.min(Math.min(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_az(_e13),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bz(_e13)),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cz(_e13));
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_az(_e13,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_az(_e13) + dz);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_bz(_e13,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bz(_e13) + dz);
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_cz(_e13,dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cz(_e13) + dz);
			return z;
		}, triangle : function(ax_,ay_,az_,bx_,by_,bz_,cx_,cy_,cz_) {
			return dsHelper_flatInterleave_ArrayColorTrianglesUV.triangle(_e14,ax_,ay_,az_,bx_,by_,bz_,cx_,cy_,cz_);
		}, getTriangle3D : function() {
			var pa = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(_e15),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(_e15),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_az(_e15),1.);
			var pb = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(_e15),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(_e15),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bz(_e15),1.);
			var pc = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(_e15),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(_e15),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cz(_e15),1.);
			return new trilateral3_structure_Triangle3D(pa,pb,pc);
		}, transform : function(m) {
		...
		var triangleAbstractUV = { moveDelta : function(du,dv) {
			dsHelper_flatInterleave_ArrayColorTrianglesUV.moveDeltaUV(_e17,du,dv);
		}, get_u : function() {
			...
			return dsHelper_flatInterleave_ArrayColorTrianglesUV.triangleUV(_e24,uA_,vA_,uB_,vB_,uC_,vC_,windAdjust_);
		...
		var _e32 = t;
		var color3Abstract = { set_argb : function(col) {
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_redA(_e26,(col >> 16 & 255) / 255);
			var v = (col & 255) / 255;
			...
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_redB(_e26,(col >> 16 & 255) / 255);
			var v = (col & 255) / 255;
			...
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_redC(_e26,(col >> 16 & 255) / 255);
			var v = (col & 255) / 255;
			...
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_redA(_e27,(col >> 16 & 255) / 255);
			var v = (col & 255) / 255;
			...
			return Math.round(_e28[(_e28[0] | 0) * 27 + 6 + 1] * 255) << 24 | Math.round(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_redA(_e28) * 255) << 16 | Math.round(_e28[(_e28[0] | 0) * 27 + 4 + 1] * 255) << 8 | Math.round(_e28[(_e28[0] | 0) * 27 + 5 + 1] * 255);
		}, set_argbB : function(col) {
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_redB(_e29,(col >> 16 & 255) / 255);
			var v = (col & 255) / 255;
			...
			return Math.round(_e30[(_e30[0] | 0) * 27 + 15 + 1] * 255) << 24 | Math.round(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_redB(_e30) * 255) << 16 | Math.round(_e30[(_e30[0] | 0) * 27 + 13 + 1] * 255) << 8 | Math.round(_e30[(_e30[0] | 0) * 27 + 14 + 1] * 255);
		}, set_argbC : function(col) {
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_redC(_e31,(col >> 16 & 255) / 255);
			var v = (col & 255) / 255;
			...
			return Math.round(_e32[(_e32[0] | 0) * 27 + 24 + 1] * 255) << 24 | Math.round(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_redC(_e32) * 255) << 16 | Math.round(_e32[(_e32[0] | 0) * 27 + 22 + 1] * 255) << 8 | Math.round(_e32[(_e32[0] | 0) * 27 + 23 + 1] * 255);
		}};
		var _e33 = t;
		var _e34 = t;
		var _e35 = t;
		...
		var _e49 = t;
		var paintAbstract = { triangle : function(ax_,ay_,az_,bx_,by_,bz_,cx_,cy_,cz_) {
			return dsHelper_flatInterleave_ArrayColorTrianglesUV.triangle(_e33,ax_,ay_,az_,bx_,by_,bz_,cx_,cy_,cz_);
		}, triangleUV : function(uA_,vA_,uB_,vB_,uC_,vC_,windAdjust_) {
			return dsHelper_flatInterleave_ArrayColorTrianglesUV.triangleUV(_e34,uA_,vA_,uB_,vB_,uC_,vC_,windAdjust_);
		}, cornerColors : function(colorA,colorB,colorC) {
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_redA(_e35,(colorA >> 16 & 255) / 255);
			var v = (colorA & 255) / 255;
			...
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_redB(_e35,(colorB >> 16 & 255) / 255);
			var v = (colorB & 255) / 255;
			...
			dsHelper_flatInterleave_ArrayColorTrianglesUV.set_redC(_e35,(colorC >> 16 & 255) / 255);
			var v = (colorC & 255) / 255;
			...
			while(_g < _g1) {
				var i = _g++;
				dsHelper_flatInterleave_ArrayColorTrianglesUV.set_redA(_e36,(color >> 16 & 255) / 255);
				var v = (color & 255) / 255;
				...
				dsHelper_flatInterleave_ArrayColorTrianglesUV.set_redB(_e36,(color >> 16 & 255) / 255);
				var v3 = (color & 255) / 255;
				...
				dsHelper_flatInterleave_ArrayColorTrianglesUV.set_redC(_e36,(color >> 16 & 255) / 255);
				var v6 = (color & 255) / 255;
			...
			return new trilateral3_structure_TriInt(Math.round(_e37[(_e37[0] | 0) * 27 + 6 + 1] * 255) << 24 | Math.round(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_redA(_e37) * 255) << 16 | Math.round(_e37[(_e37[0] | 0) * 27 + 4 + 1] * 255) << 8 | Math.round(_e37[(_e37[0] | 0) * 27 + 5 + 1] * 255),Math.round(_e37[(_e37[0] | 0) * 27 + 15 + 1] * 255) << 24 | Math.round(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_redB(_e37) * 255) << 16 | Math.round(_e37[(_e37[0] | 0) * 27 + 13 + 1] * 255) << 8 | Math.round(_e37[(_e37[0] | 0) * 27 + 14 + 1] * 255),Math.round(_e37[(_e37[0] | 0) * 27 + 24 + 1] * 255) << 24 | Math.round(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_redC(_e37) * 255) << 16 | Math.round(_e37[(_e37[0] | 0) * 27 + 22 + 1] * 255) << 8 | Math.round(_e37[(_e37[0] | 0) * 27 + 23 + 1] * 255));
		}, transform : function(m) {
			...
			var pa = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ax(_e40),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_ay(_e40),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_az(_e40),1.);
			var pb = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bx(_e40),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_by(_e40),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_bz(_e40),1.);
			var pc = new trilateral3_matrix_Vertex(dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cx(_e40),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cy(_e40),dsHelper_flatInterleave_ArrayColorTrianglesUV.get_cz(_e40),1.);
			return new trilateral3_structure_Triangle3D(pa,pb,pc);
		}, getTriangleUV : function() {
			...
			return dsHelper_flat_io_ArrayFlatDepth.rangeToEnd(_e48,id * 27,27 * len | 0,_e48.length - 1);
		}, swap : function(id0,id1,len) {
			var start0 = id0 * 27;
			var start1 = id1 * 27;
			var totalLen = 27 * len | 0;
