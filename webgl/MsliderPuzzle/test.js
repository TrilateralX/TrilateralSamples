...
TrilateralSliderPuzzle.prototype = $extend(kitGL_glWeb_PlyMix.prototype,{
	draw: function() {
		haxe_Log.trace("arrow keys or mouse for direction",{ fileName : "TrilateralSliderPuzzle.hx", lineNumber : 99, className : "TrilateralSliderPuzzle", methodName : "draw"});
		haxe_Log.trace("space to muddle",{ fileName : "TrilateralSliderPuzzle.hx", lineNumber : 100, className : "TrilateralSliderPuzzle", methodName : "draw"});
		haxe_Log.trace("enter to solve",{ fileName : "TrilateralSliderPuzzle.hx", lineNumber : 101, className : "TrilateralSliderPuzzle", methodName : "draw"});
		haxe_Log.trace("delete to undo",{ fileName : "TrilateralSliderPuzzle.hx", lineNumber : 102, className : "TrilateralSliderPuzzle", methodName : "draw"});
	...
	,mouseDown: function(e) {
		...
		e.stopPropagation();
		e.preventDefault();
		var xy = new trilateral3_structure_XY(p.clientX,p.clientY);
		var x = xy.x * this.pixelRatio;
		var y = xy.y * this.pixelRatio;
		var mxy = new trilateral3_structure_XY(x,y);
		this.movePiece = true;
		this.step = 0.06;
		var results = this.quadDepth.fullHit(mxy.x,mxy.y);
	...
	,mouseMove: function(e) {
		...
		var mxy = new trilateral3_structure_XY(x,y);
		if(this.wasHit) {
			var px = mxy.x - this.tempX;
			var py = mxy.y - this.tempY;
